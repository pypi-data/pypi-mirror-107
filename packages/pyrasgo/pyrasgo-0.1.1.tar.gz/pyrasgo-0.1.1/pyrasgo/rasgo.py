...
# -------------------
    ...
    def activate_experiment(
        ...
        """
        Activate an experiment with a given name. This expermient name can be used to
        track dataframe activity with selected methods
        """
        self._experiment = experiment_name
        self.evaluate = Evaluate(experiment=self._experiment, api_key=self._session_api_key)
        self.prune = Prune(experiment=self._experiment, api_key=self._session_api_key)
        return(f"Ongoing experiment now in progress with name: {self._experiment}")
