...
from pyrasgo.utils.monitoring import log_event
...
class Prune(Connection):
    ...
    def columns_with_missing_data(self, df: pd.DataFrame, 
                                  ...
                                  threshold: float = 0,
                                  rasgo_df_id: str = None) -> pd.DataFrame:
        """
        ...
        ----------
            ...
            rasgo_df_id: (Optional) str:
                Provides tracking for dataframe pruning.
    ...
    def rows_with_missing_data(self, df: pd.DataFrame, 
        ...
        ----------
            ...
            rasgo_df_id: (Optional) str:
                Provides a dataframe ID to track dataframe pruning in an experiment.
