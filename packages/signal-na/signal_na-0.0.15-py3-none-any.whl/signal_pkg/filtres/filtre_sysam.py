...
class FiltreSysam(FiltreBase):
    ...
    def calculer_vecteur_H_cplx(self, affichage = True):
        self.acquerir_bode(self.liste_fmin_fmax, self.n_points)
        
    def acquerir_bode(self, liste_fmin_fmax, n_points):
...
if __name__ == "__main__":
    ...
    filtre.configurer_sortie_sysam("SA2", 0.1)
