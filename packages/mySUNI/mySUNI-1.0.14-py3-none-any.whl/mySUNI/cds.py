...
q = {'mySUNI-WorkShop-00-Python': ['mySUNI-WorkShop-00-Python-실습.ipynb'],
 ...
 'mySUNI-WorkShop-03-타이타닉': ['mySUNI-WorkShop-03-타이타닉 생존자 분석-실습.ipynb'],
 'mySUNI-WorkShop-04-타이타닉': ['mySUNI-WorkShop-04-타이타닉 생존자 예측-실습.ipynb'],
 'mySUNI-WorkShop-06-웨이퍼': ['mySUNI-WorkShop-06-웨이퍼 불량 유형 분류-실습(코드추가).ipynb',
  'mySUNI-WorkShop-06-웨이퍼 불량 유형 분류-실습.ipynb'],
 'mySUNI-WorkShop-07-따릉이': ['mySUNI-WorkShop-07-따릉이 대여량 예측-실습(코드추가).ipynb',
  'mySUNI-WorkShop-07-따릉이 대여량 예측-실습.ipynb'],
 'mySUNI-WorkShop-08-집': ['mySUNI-WorkShop-08-집 값 예측-실습(코드추가).ipynb',
  'mySUNI-WorkShop-08-집 값 예측-실습.ipynb'],
 'mySUNI-WorkShop-09-머신러닝': ['mySUNI-WorkShop-빌딩 전력 소모량 예측 (실습).ipynb',
...
s = {'mySUNI-WorkShop-00-Python': ['mySUNI-WorkShop-00-Python-해설.ipynb'],
 ...
 'mySUNI-WorkShop-03-타이타닉': ['mySUNI-WorkShop-03-타이타닉 생존자 분석-해설.ipynb'],
 'mySUNI-WorkShop-04-타이타닉': ['mySUNI-WorkShop-04-타이타닉 생존자 예측-해설.ipynb'],
 'mySUNI-WorkShop-06-웨이퍼': ['mySUNI-WorkShop-06-웨이퍼 불량 유형 분류-해설.ipynb'],
 'mySUNI-WorkShop-07-따릉이': ['mySUNI-WorkShop-07-따릉이 대여량 예측-해설.ipynb'],
 'mySUNI-WorkShop-08-집': ['mySUNI-WorkShop-08-집 값 예측-해설.ipynb'],
 'mySUNI-WorkShop-09-머신러닝': ['mySUNI-WorkShop-빌딩 전력 소모량 예측 (해설).ipynb',
...
def download_workshop(workshop_name, sol=False):
    # auth
    username = 'mysuni'
    password = 'mysuni1!'
    ...
    for workshop_file in workshop_files:
        ...
        r = requests.get(fileurl, auth=HTTPBasicAuth(username, password))
        filepath = os.path.join('workshop', 'workshop_name', workshop_file)
        open(filepath, 'wb').write(r.content)
