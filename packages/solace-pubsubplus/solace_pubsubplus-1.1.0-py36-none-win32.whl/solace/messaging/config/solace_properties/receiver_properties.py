...
"""
    ...
    The acceptable value for this property is 
    :py:const:`ELASTIC<solace.messaging.config.solace_constants.receiver_constants.ELASTIC>`.
    ...
    :py:meth:`DireectMessageReceiverBuilder.from_properties()<solace.messaging.builder.direct_message_receiver_builder.DirectMessageReceiverBuilder.from_properties>`
    method.
    
    This method is an alternative to setting the back pressure of a direct receiver by
