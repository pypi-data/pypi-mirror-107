...
""" This module that contains the interface definition for the replay strategy.
...
class ReplayStrategy(ABC):
    ...
    def all_messages() -> 'AllMessagesReplay':
        ...
        Returns:
            A new instance of the class :py:class:`solace.messaging.config.replay_strategy.AllMessagesReplay`.
        """
...
class AllMessagesReplay(ReplayStrategy):
    """
    Replay strategy to get all messages.
    """


class TimeBasedReplay(ReplayStrategy):
    """Time based message replay strategy"""
    ...
    def __str__(self):
        return TimeBasedReplay.__name__ + '{replay_date:' + str(self._replay_date) + '}'
