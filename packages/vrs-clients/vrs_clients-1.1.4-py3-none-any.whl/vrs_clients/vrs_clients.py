...
class PlotlyVisualizationResourceClient(E360ServiceClient):
    ...
    def create(self, payload: Dict, from_plotly: bool = False, **kwargs: Any) -> PlotlyVisualisationModel:
        ...
        if from_plotly is True:
            ...
            data = PlotlyVisualisationModel.Schema().load(payload)  # type: ignore
            data = PlotlyVisualisationModel.Schema().dump(data)  # type: ignore
...
class VisualizationResourceClient(E360ServiceClient):
    ...
    def _get_headers(self, auth_headers: Dict, content_type: str = "application/json-patch+json") -> dict:
        return {
            "accept": "application/json",
    ...
    def upload_file(self, visualisation_id: str, file_path: pathlib.Path, content_type: str = "text/csv", **kwargs: Any) -> bool:
        """
