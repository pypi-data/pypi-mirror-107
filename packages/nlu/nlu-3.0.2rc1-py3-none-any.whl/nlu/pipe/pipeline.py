...
class NLUPipeline(BasePipe):
    ...
    def viz(self, text_to_viz:str, viz_type='', labels_to_viz=None,viz_colors={},return_html=False, write_to_streamlit=False):
        ...
        if self.has_licensed_components==False : HTML = VizUtils.viz_OS(anno_res, self, viz_type,viz_colors,labels_to_viz,is_databricks_env,write_to_streamlit)
    ...
    def viz_streamlit(self,
        ...
        # TODO try error import streamlit/pyplot/sklearn
        # TODO DEFINE LIST OF "CLASSIFUIERS" and DEDUCT THEIR COLS
        # -> Becoems display_classifier()! ->(Classifier, Resolver, Yake, NER, POS, etc..)
        # -> Display tokens shows ALL cols
        ...
        VizUtilsStreamlitOS.viz_streamlit(self,text,title,show_feature_select,features,metadata,output_level,positions,)

        ModelHubUtils.viz_streamlit()
    ...
    def viz_streamlit_token(
        ...
        VizUtilsStreamlitOS.visualize_tokens_information(self,text,title,show_feature_select,features,metadata,output_level,positions,generate_code_sample)
    ...
    def viz_streamlit_classes(
        ...
        VizUtilsStreamlitOS.visualize_classes( self,text,output_level,title,metadata,positions,generate_code_sample)
    ...
    def viz_streamlit_dep_tree(
        ...
        VizUtilsStreamlitOS.visualize_dep_tree( self,text,title,generate_code_sample)
    ...
    def viz_streamlit_ner(
        ...
        VizUtilsStreamlitOS.visualize_ner(self,text,ner_tags,show_label_select,show_table,title,colors,show_color_selector,generate_code_sample)
    ...
    def viz_streamlit_word_similarity(
        ...
        VizUtilsStreamlitOS.display_word_similarity(self, default_texts, threshold, title, show_table, display_embed_information, display_sim_matrix, show_dist_algo_select, dist_metrics,generate_code_sample)