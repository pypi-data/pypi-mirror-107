...
ADMINS = ['sgotting21@gmail.com']
USERS = ['sgotting21@gmail.com']
...
Instantiates this object ready to send mail to test server
        ...
        '''
        return cls('localhost', port=1025, default_from='admin@slgotting.com')

    @classmethod
    def init_default_settings(cls):

        return cls('smtp.gmail.com', 'sgotting21@gmail.com',
                   'xnzjgqgdykepqmbs', 465)
    ...
    def send_mail(self, subject, body, to=None, from_=None,
                  img_attachments=[], img_types='email format'):
        '''
