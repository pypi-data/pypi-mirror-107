...
class SurveyV1API(API):
    ...
    def list(
        ...
        return self._search_internal(
            [], list_seismics, list_seismic_stores, include_metadata, crs, in_wkt, include_grid_transformation
        )
    ...
    def search(
        ...
        return self._search_internal(
            search_specs, list_seismics, list_seismic_stores, include_metadata, crs, in_wkt, include_grid_transformation
        )
    ...
    def register(
        ...
        """
        return self.v0_survey_api.register(survey_name, metadata, external_id, crs, grid_transformation)
    ...
    def edit(
        ...
        """
        return self.v0_survey_api.edit(survey_id, survey_name, metadata, external_id, crs, grid_transformation)
