...
class LocationNER(NERWrapper):
    ...
    def annotate(self, text):
        ...
        for start, end, word in span_indexed_word_tokenize(text):
...
class CitiesNER(NERWrapper):
    ...
    def annotate(self, text):
        ...
        conf = 0.55 if self.lowercase else 0.7
...
if __name__ == "__main__":
    ...
    ner = CitiesNER()
    #ner = LocationNER()
    text = """Portugal was born in Guimarães but the capital is Lisbon"""
