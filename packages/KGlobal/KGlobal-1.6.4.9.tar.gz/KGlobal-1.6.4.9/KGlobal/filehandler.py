...
class FileParser(object):
    ...
    def stream_data(self, buffer=DEFAULTBUFFER, engine='default', **kwargs):
        """
        ...
        :param kwargs: [Optional] Kwarg values you wish to pass through
        ...
        :var **kwargs: Kwarg values that you specify in stream_data wrapper
        """

        def registerhandler(handler):
            self.__streams.add_stream(engine, handler, buffer, **kwargs)
            return handler
