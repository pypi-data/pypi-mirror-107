...
def create_s3_cli(cli):


    @cli.group(help="S3 Interface")
    def s3():
        pass

    @s3.command('list', help='List S3 objects')
    @click.option('--inputs',
    ...
    @s3.command(help='Upload files to S3')
    @click.option('--file',
                'files',
    ...
    @s3.command(help='Download files from S3')
    @click.option('--recursive/--no-recursive',
                default=False,
                show_default=True,
                help='Download prefixes recursively.')
