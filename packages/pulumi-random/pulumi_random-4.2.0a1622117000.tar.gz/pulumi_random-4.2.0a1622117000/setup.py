...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', '4.2.0-alpha.1622117000+49d97706'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random 4.2.0-alpha.1622117000+49d97706`
                """)
            else:
                raise
