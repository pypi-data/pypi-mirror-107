...
class Engine:
  ...
  def __init__(self,start_date, end_date, portfolio, weights, benchmark):
...
def graph_allocation(portfolio, wts):
  fig1, ax1 = plt.subplots()
  ax1.pie(wts, labels=portfolio, autopct='%1.1f%%',
...
def empyrial(my_portfolio, rf=0.0, sigma_value=1, confidence_value=0.95):
  ...
  graph_allocation(portfolio=my_portfolio.portfolio,wts=my_portfolio.weights)
  display(df)
