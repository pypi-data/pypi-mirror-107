...
GIT_CLONE_URLS = {
    'ssh': 'git@ssh.dev.azure.com:v3/energinet/AnalyticsOps/pipelines',
    'https': 'https://energinet@dev.azure.com/energinet/AnalyticsOps/_git/pipelines',  # noqa: E501
}
...
def add_pipeline_files(project):
    ...
    click.echo((
        ...
        'https://dev.azure.com/energinet/AnalyticsOps/_git/pipelines'
    ))
    click.echo('-' * 79)
