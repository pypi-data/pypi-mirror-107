...
from thystreet import rest
from thystreet.configuration import Configuration
from thystreet.exceptions import ApiTypeError, ApiValueError, ApiException
from thystreet.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'ThyStreet/0.0.1/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.set_status  # this is an instance of the class Endpoint
        api_instance.set_status()  # this invokes api_instance.set_status.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.set_status.callable or self.callable in this class
