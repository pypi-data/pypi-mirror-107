...
class FullScan():
    ...
    def config_firmware(
        self,
        ni_700_master_current='4.1.419',
        ni_x100_master_current='4.1.419',
        nx_master_current='1.6.179',
        ni_device_current='',
        nx_device_current='',
        check_firmware=True,
        ):
        self.ni_700_master_current = ni_700_master_current
        self.ni_x100_master_current = ni_x100_master_current
        self.nx_master_current = nx_master_current
        self.ni_device_current = ni_device_current
        self.nx_device_current = nx_device_current
    ...
    def _check_firmware(self):
        if self.check_firmware:
            ...
            master_fw.set_versions(
                ni_700_current=self.ni_700_master_current,
                ni_x100_current=self.ni_x100_master_current,
                nx_current=self.nx_master_current
                )
            ...
            device_fw.set_versions(
                    ni_current=self.ni_device_current,
                    nx_current=self.nx_device_current
                )
