...
class MNIST(fuzzy_obj):
    ...
    def train_dataloader(self, batch_size=1, shuffle=True, num_workers=0):
        return DataLoader(self.__train_set, batch_size=batch_size, shuffle=shuffle, num_workers=num_workers)

    def test_dataloader(self, batch_size=1, shuffle=True, num_workers=0):
        return DataLoader(self.__test_set, batch_size=batch_size, shuffle=shuffle, num_workers=num_workers)
