...
class MNIST(fuzzy_obj):
    ...
    def train_dataloader(batch_size=1, shuffle=True):
        return DataLoader(self.__train_set, batch_size=batch_size, shuffle=shuffle)

    def test_dataloader(batch_size=1, shuffle=True):
        return DataLoader(self.__test_set, batch_size=batch_size, shuffle=shuffle)
