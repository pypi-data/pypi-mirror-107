...
def build_argparser():
    ...
    # TODO: --report flag/argument, or subcommand? Store errors in sqlite?
...
def main():  # pylint: disable=too-many-branches
    ...
    try:
        if hasattr(args, "func"):
            ...
            # TODO: make this less fragile and more automated
            args_dict.pop("func")
            args_dict.pop("debug")
            if args_dict:
                args.func(args=args)
        ...
        print("Issue connecting to an sqlite database: " + repr(sql_exception))
        if DEBUG:
            raise
