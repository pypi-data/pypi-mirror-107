...
from ntclient.argparser import parser_funcs
...
def build_recipe_subcommand(subparsers):
    ...
    recipe_add_parser.add_argument(
        ...
        metavar="id,grams",
        nargs="+",
        help="food_id,grams e.g. 1001,15 for 15 grams butter",
    )
    recipe_add_parser.set_defaults(func=parser_funcs.recipe_add)
    ...
    recipe_edit_parser.set_defaults(func=parser_funcs.recipe_edit)

    recipe_delete_parser = recipe_subparsers.add_parser(
        "delete", help="delete a recipe"
    )
    ...
    recipe_parser.add_argument(
        ...
        dest="recipe_id",
        type=int,
        help="view and analyze recipe by ID",
    )
    recipe_parser.set_defaults(func=parser_funcs.recipe)
