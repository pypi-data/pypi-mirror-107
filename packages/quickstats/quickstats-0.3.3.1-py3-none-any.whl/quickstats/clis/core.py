...
def harmonize_np(ws_files, reference, input_list, base_path, outfile):
    """
    ...
    if (len(ws_files) > 0) and input_list is not None:
    ...
    if len(ws_files) > 0:
        ...
        harmonizer.harmonize_multi_input(input_list, base_path, outfile=outfile)    