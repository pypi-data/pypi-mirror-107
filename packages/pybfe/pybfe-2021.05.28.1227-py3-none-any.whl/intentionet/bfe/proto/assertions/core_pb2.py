...
_ASSERTIONINPUT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='devices_have_text', full_name='com.intentionet.bfe.assertions.AssertionInput.devices_have_text', index=21,
    ...
    _descriptor.FieldDescriptor(
      name='description', full_name='com.intentionet.bfe.assertions.AssertionInput.description', index=22,
    ...
    _descriptor.FieldDescriptor(
      name='title', full_name='com.intentionet.bfe.assertions.AssertionInput.title', index=23,
...
_ASSERTIONRESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='devicesHaveDefinitionText', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='devices_have_text', full_name='com.intentionet.bfe.assertions.AssertionResult.devices_have_text', index=21,
      number=51, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='devicesHaveText', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='com.intentionet.bfe.assertions.AssertionResult.metadata', index=22,
