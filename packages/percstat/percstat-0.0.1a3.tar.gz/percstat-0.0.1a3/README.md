...
Use the package manager [pip](https://pip.pypa.io/en/stable/) to install percstat.
...
#class etc
a=p.etc.dice #value=[1,2,3,4,5,6],change a to other
b=p.etc.coin #value=[0,1],change b to other
#class percentage
