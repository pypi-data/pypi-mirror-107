...
class TableStreamUpdater:
    ...
    def update(self, result: DataFrame, table_definition: TableDefinition, checkpoint_location: str, callback: Callable, options: dict):
        ...
        self.__data_stream_writer.update(result, output_table_name, table_definition.schema, checkpoint_location, callback, options)
