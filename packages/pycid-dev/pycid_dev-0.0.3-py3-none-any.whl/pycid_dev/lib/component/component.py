...
class Component(object):
    ...
    def edit_attribute_by_id(self, attribute_id, new_attribute_name: str = None, new_attribute_value=None, new_attribute_extra=None):
        """
        new_attribute_extra: tuple with a key and value for the extra
        """
        ...
        #
        if (not new_attribute_name) and (not new_attribute_value) and (not new_attribute_extra):
        ...
        attribute_extras = {} if "extras" not in attr else attr["extras"]
        if new_attribute_extra:
            attribute_extras[new_attribute_extra[0]] = new_attribute_extra[1]
