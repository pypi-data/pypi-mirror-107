...
class LicensingApiRouter(VersionRouter):
    ...
    function_library = {
        "get_license": {"4.8.4-5.0.2": get_license},
        "put_license_upgrade": {"4.8.4-5.0.2": put_license_upgrade},
        "put_set_license_parameters": {"4.8.4-5.0.2": put_set_license_parameters},
        "upload_license": {"4.8.4-5.0.2": upload_license},
    }
