...
class OverlayNetworkApiRouter(VersionRouter):
    function_library = {
        "delete_clientpack_tag": {"4.8.4-5.0.2": delete_clientpack_tag},
        "get_clientpack": {"4.8.4-5.0.2": get_clientpack},
        "get_clientpacks": {"4.8.4-5.0.2": get_clientpacks},
        "get_clients_status": {"4.8.4-5.0.2": get_clients_status},
        "get_connected_subnets": {"4.8.4-5.0.2": get_connected_subnets},
        "get_download_clientpack": {"4.8.4-5.0.2": get_download_clientpack},
        "get_download_named_clientpack": {"5.0.2": get_download_named_clientpack},
        "post_checkout_next_clientpack": {"4.8.4-5.0.2": post_checkout_next_clientpack},
        "post_create_clientpack_tag": {"4.8.4-5.0.2": post_create_clientpack_tag},
        "post_reset_all_clients": {"4.8.4-5.0.2": post_reset_all_clients},
        "post_reset_client": {"4.8.4-5.0.2": post_reset_client},
        "post_add_clientpacks": {"4.8.4-5.0.2": post_add_clientpacks},
        "put_update_clientpack": {"4.8.4-5.0.2": put_update_clientpack},
        "put_disconnect_clientpack": {"4.8.4-5.0.2": put_disconnect_clientpack},
        "put_update_all_clientpacks": {"4.8.4-5.0.2": put_update_all_clientpacks},
    }
