...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '5.5.0-alpha.1622037866+0e529d4f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 5.5.0-alpha.1622037866+0e529d4f`
                """)
            else:
                raise
