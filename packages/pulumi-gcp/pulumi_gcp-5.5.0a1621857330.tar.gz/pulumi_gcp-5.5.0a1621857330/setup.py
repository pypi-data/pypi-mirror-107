...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '5.5.0-alpha.1621857330+6c0a7d3f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 5.5.0-alpha.1621857330+6c0a7d3f`
                """)
            else:
                raise
