...
setup(
    ...
    packages=['Augmentext'],
    version='0.1.4',
    description='Text augmentation library for NLP applications.',
    long_description='Text augmentation library for NLP applications.',
    license='MIT',
    ...
    keywords=['text', 'augmentation', 'generation', 'NLP', 'machine', 'learning'],
