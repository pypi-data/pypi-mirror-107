...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', '4.1.0-alpha.1622142893+f0737b95'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab 4.1.0-alpha.1622142893+f0737b95`
                """)
            else:
                raise
