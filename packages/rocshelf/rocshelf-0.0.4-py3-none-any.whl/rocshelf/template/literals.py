...
from rocshelf.template import basic
...
LITERALS: dict[str, list[literals.Literal]] = {}
...
class LiteralValue(object):
    ...
    def __init__(self, literal: type[Literal], patterIndex: int, fileSpan: basic.FileSpan, contentMath: re.Match):
...
class Literal(object):
    ...
    contextType: str
    node: type[basic.Node]
    patterns: tuple[re.Pattern, ...]

    def __init__(self, contextType: str, node: type[basic.Node], *args, **kwargs):
