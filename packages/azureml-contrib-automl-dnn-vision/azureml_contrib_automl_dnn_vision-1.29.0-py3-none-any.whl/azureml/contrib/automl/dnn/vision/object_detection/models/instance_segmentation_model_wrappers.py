...
from azureml.contrib.automl.dnn.vision.object_detection.models.object_detection_model_wrappers import \
...
class MaskRCNNResnet50FPNWrapper(FasterRCNNResnetFPNWrapper):
    ...
    def __init__(self, number_of_classes=None, model_state=None, specs=None, model_settings=None):
        ...
        """
        super().__init__(model_name=ModelNames.MASK_RCNN_RESNET50_FPN, number_of_classes=number_of_classes,
    ...
    def _model_constructor(self, pretrained, load_pretrained_model_dict, **kwargs):
        ...
        return PretrainedModelFactory.maskrcnn_resnet50_fpn(pretrained=True,
