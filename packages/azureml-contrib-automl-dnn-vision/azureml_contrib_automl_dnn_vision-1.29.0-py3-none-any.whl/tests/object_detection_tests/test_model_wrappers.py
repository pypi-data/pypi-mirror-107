...
from azureml.contrib.automl.dnn.vision.object_detection.models.object_detection_model_wrappers \
    ...
    RetinaNetModelSettings, FasterRCNNResnet18FPNWrapper, FasterRCNNResnet34FPNWrapper, \
...
class TestModelWrappers:
    ...
    def test_wrappers_export_onnx(self, data_root):
        ...
        r18_settings = FasterRCNNModelSettings(settings={"box_score_thresh": 0.05})
        r18 = FasterRCNNResnet18FPNWrapper(number_of_classes=number_of_classes,
                                           model_settings=r18_settings)
        ...
        r34_settings = FasterRCNNModelSettings(settings={"box_score_thresh": 0.05})
        r34 = FasterRCNNResnet34FPNWrapper(number_of_classes=number_of_classes,
                                           model_settings=r34_settings)
