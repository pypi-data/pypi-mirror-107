...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', '3.1.0-alpha.1622115380+42143bc4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp 3.1.0-alpha.1622115380+42143bc4`
                """)
            else:
                raise
