...
def module(name):
    ...
    try:
        ...
        return False
# builtins.__dict__["module"]=module()

# print("@cmd.py安裝@",module("cmds"))
# import site
# print("@site@os.path@",id(site))


# ##
# import os,sys
# if not module("cmds") and not 'install' in sys.argv:
#     # os.system("pip install cmd.py") ## pip會[call] os.path 變成迴圈
#     pass
...
def  cleanup_function(siteOP):
        def module(name):
            ...
            try:
                ...
                return False  
        import site
        print("關閉檔案",id(site),id(siteOP),module("cmds"))  
