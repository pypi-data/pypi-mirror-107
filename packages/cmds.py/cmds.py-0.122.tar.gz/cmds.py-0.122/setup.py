          ...
          def  run(self):
                ...
                def  cleanup_function(siteOP):
                    if Var.nameA=="cmds.py":
                        ...
                        ## True 表示第一次
                        import os
                        if not "siteD" in list(os.path.__dict__.keys()): 
...
BL = module("'''+Var.nameA[0:-3]+'''")
if not BL:
    # print("pip install cmds.py. [尚未安裝]")
else:
    import builtins
    builtins.__dict__["module"]= BL
...
'''
                        ...
                        print("::siteD()::",siteD(),not "siteD" in list(os.path.__dict__.keys()) )
