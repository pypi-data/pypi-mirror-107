...
class QGraph:
    ...
    def _fetch_qgraph_json(self):
        queryfilter = self._filters.get("query_string")
        if queryfilter:
            query_string = queryfilter.query_string
        else:
            query_string = ""
        ...
        qgraph_json = self.qlattice._generate(specs, self.registers, max_depth, query_string=query_string)
        return qgraph_json
