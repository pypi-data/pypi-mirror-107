...
class GraphMetricsMixin:
    ...
    def plot_roc_curve(self, data: Iterable, threshold:float=None, title:str="ROC curve", ax=None, **kwargs) -> None:
        """
        ...
        """
        pred = self.predict(data)
        feyn.plots.plot_roc_curve(data[self.target], pred, threshold, title, ax, **kwargs)
