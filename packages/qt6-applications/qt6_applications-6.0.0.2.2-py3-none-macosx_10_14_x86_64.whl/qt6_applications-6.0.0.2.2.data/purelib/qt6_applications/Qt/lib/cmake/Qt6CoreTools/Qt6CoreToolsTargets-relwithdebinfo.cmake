...
set_target_properties(Qt6::moc PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/moc"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qt6::moc )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::moc "${_IMPORT_PREFIX}/bin/moc" )
...
set_target_properties(Qt6::rcc PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/rcc"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qt6::rcc )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::rcc "${_IMPORT_PREFIX}/bin/rcc" )
...
set_target_properties(Qt6::tracegen PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/tracegen"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qt6::tracegen )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::tracegen "${_IMPORT_PREFIX}/bin/tracegen" )
...
set_target_properties(Qt6::cmake_automoc_parser PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/cmake_automoc_parser"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qt6::cmake_automoc_parser )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::cmake_automoc_parser "${_IMPORT_PREFIX}/bin/cmake_automoc_parser" )
...
set_target_properties(Qt6::qlalr PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/qlalr"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qt6::qlalr )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::qlalr "${_IMPORT_PREFIX}/bin/qlalr" )
