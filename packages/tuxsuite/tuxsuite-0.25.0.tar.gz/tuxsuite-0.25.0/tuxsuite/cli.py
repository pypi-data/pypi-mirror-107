...
def results(build, test, plan, from_json, json_out):
    ...
    try:
        ...
        if plan:
            ...
            for result in result_json["builds"].get("results", None):
                format_result(result)
            for result in result_json["tests"].get("results", None):
                format_result(result, tuxapi_tests_url=tuxapi_tests_url)
