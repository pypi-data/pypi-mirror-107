...
- resources (dict; optional):
    ...
    @_explicitize_args
    def __init__(self, id=Component.REQUIRED, deckglSpec=Component.UNDEFINED, resources=Component.UNDEFINED, coords=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'coords', 'deckglSpec', 'resources']
        self._type = 'DeckGLMap'
        self._namespace = 'webviz_subsurface_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'coords', 'deckglSpec', 'resources']
