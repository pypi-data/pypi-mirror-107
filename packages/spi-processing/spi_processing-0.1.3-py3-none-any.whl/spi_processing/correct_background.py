...
def correct_background(input_file: str, max_background: int = 50,
    ...
    # For lower number, estimation quality is bad and calculations take extremely long time
    if total_frames < 10:
        warnings.warn("Not enough images to estimate background: " + \
                      "{} < 10 images".format(total_frames))
        return
