...
def main():
    ...
    parser.add_argument(
        '-d', '--dataset', help="add file to existing dataset with this id", type=str, default=None)
    parser.add_argument('-u', '--user', type=str, default=None,
                        help="your username (or email address)")
    parser.add_argument('-p', '--password', type=str,
                        default=None, help="your password")
    parser.add_argument('-t', '--title', type=str,
                        default=None, help="the title of the new dataset")
    parser.add_argument(
        '-m', '--metadata', help='upload files as metadata instead of expression data', action='store_true')
    parser.add_argument(
        '--dataset_type', help='the dataset type (defaults to cs-singlecell', type=str, default='cs-singlecell')
    ...
    for file in args.file:
        ...
        try:
            client.add_file_to_dataset(
                args.dataset, file, 'metadata' if args.metadata else 'expressiondata', show_progress_bar=True)
        except Exception as e:
