...
class HookAPI(MethodView):
    ...
    def post(self):
        ...
        console.print("webhook arrived", style="bold white on blue", justify="center")
...
class LocalHook:
    ...
    def listen(self):
        ...
        console.print(" :tada: Ready to receive webhooks on terminal", ":thumbs_up:")
        console.print(f" :tada: Set your webhook URL as {url}")
        console.print(" :tada: Traffic stats available on http://127.0.0.1:4040")
