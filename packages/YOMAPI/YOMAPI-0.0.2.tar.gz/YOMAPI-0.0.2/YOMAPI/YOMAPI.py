...
class YOMAPI(metaclass=Singleton):
    ...
    """
    def update_bulk_promotions(self, batch, fields_not_to_be_updated, token, sync_job_id, from_integration):
    ...
    def update_bulk_segments(self, batch, fields_not_to_be_updated, token, sync_job_id, from_integration):
    ...
    def update_bulk_user_segments(self, batch, fields_not_to_be_updated, token, sync_job_id, from_integration):
