...
KMERS = _kProcessor.KMERS
SKIPMERS = _kProcessor.SKIPMERS
MINIMIZERS = _kProcessor.MINIMIZERS
PROTEIN = _kProcessor.PROTEIN
mumur_hasher = _kProcessor.mumur_hasher
integer_hasher = _kProcessor.integer_hasher
TwoBits_hasher = _kProcessor.TwoBits_hasher
nonCanonicalInteger_Hasher = _kProcessor.nonCanonicalInteger_Hasher
protein_hasher = _kProcessor.protein_hasher
proteinDayhoff_hasher = _kProcessor.proteinDayhoff_hasher
...
def index(*args) -> "colored_kDataFrame *":
    return _kProcessor.index(*args)
class Hasher(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
