...
class AccountRepositoryResponse:
    def __init__(self, repository_id: str, name: str, provider_id: str, allow_sharing: str, open_access: str, account_id: str,
...
class RepositoryRelationshipResponse:
    def __init__(self, repo_relationship_id: str, space_id: str, deployment_type: str, account_repository_name: str, account_id: str,
                 branch: str, is_valid: bool, errors: List[Error]):

        self.id = repo_relationship_id
        self.account_id = account_id
