...
class Colony:
    ...
    def register_azure_account(self, with_tags: bool = False, **kwargs):
        ...
        if kwargs.get("external_key"):
            request["provider_id"] = kwargs.get("external_key")
    ...
    def register_aws_account(
        ...
        if name:
            request["name"] = name
        if external_key:
            request["provider_id"] = external_key
    ...
    def start_production(self, blueprint_name: str, artifacts: dict = None, inputs=None, compute_availability=None):
        ...
        json_result = json.loads(response.text)
        return CreateProductionResponse(production_id=json_result["provider_id"])
    ...
    def start_sandbox(
        ...
        result = json.loads(resp.text)
        return CreateSandboxResponse(sandbox_id=result["provider_id"])
