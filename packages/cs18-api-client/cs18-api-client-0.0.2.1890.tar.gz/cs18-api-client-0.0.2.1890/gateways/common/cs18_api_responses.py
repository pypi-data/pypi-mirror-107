...
class RepositoryProviderResponse:
    def __init__(self, id: str, name: str, details, status: str, account_id: str,
...
class AccountRepositoryResponse:
    def __init__(self, id: str, name: str, provider_id: str, allow_sharing: str, open_access: str, account_id: str,
                 is_valid: bool, connection_details, repository_url: str, errors: List[Error]):
        self.repository_url = repository_url
        self.id = id
        self.name = name
...
class RepositoryRelationshipResponse:
    def __init__(self, id: str, space_id: str, deployment_type: str, account_repository_name: str, account_id: str,
