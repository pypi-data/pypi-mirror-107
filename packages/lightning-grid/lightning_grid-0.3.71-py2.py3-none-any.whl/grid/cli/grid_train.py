...
@click.command(cls=deprecate_grid_options(_NestedCommand), context_settings=dict(ignore_unknown_options=True))
@click.option(
    '--config',
    'config',
    type=click.File('r'),
...
@click.option(
    '--framework', 'framework', type=str, required=False, default='lightning', help='Framework to use in training'
)
@click.option(
    '--use_spot',
    'use_spot',
