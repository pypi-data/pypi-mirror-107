...
def download_file_test():
    ...
    st.download_file(mtt.TEMP_IMAGE_URL, dst_path=mtt.TEMP_IMAGE_PATH)
    ...
    st.download_file(mtt.TEMP_IMAGE_URL, dst_path='{}/{}'.format(mtt.TEMP_FOLDER_PATH, mtt.TEMP_IMAGE_NAME))
