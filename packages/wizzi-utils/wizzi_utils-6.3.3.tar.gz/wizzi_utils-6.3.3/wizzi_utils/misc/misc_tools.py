...
def wizzi_utils_requirements():
    pip = 'pip install {}'
    pack = 'sub package: {}'
    optional = '-optional for tests'
    print('requirements per package:')
    print(LINES)
    print('algorithms(algs):')
    print('\t{}'.format(pip.format('sklrean')))
    print('\t{}{}'.format(pack.format('pyplot(pyplt)'), optional))
    print(LINES)
    print('coreset(cot):')
    print('\tNone')
    print(LINES)
    ...
    print('\t{}'.format(pack.format('pyplot(pyplt)')))
    print('\t{}{}'.format(pack.format('socket_tools(st)'), optional))
    print(LINES)
    print('pyplot(pyplt):')
    print('\t{}'.format(pip.format('matplotlib')))
    print('\t{}'.format(pip.format('mpl_toolkits')))
    print('\toptional for few functions:')
    print('\t\t{}'.format(pip.format('torch # cpu only')))
    ...
    print('torch(tt):')
    print('\tcpu:')
    print('\t\t{}'.format(pip.format('torch')))
    print('\tgpu(cuda 9 and 9.1):')
    url = 'https://download.pytorch.org/whl/cu90/torch_stable.html'
    print('\t\t{}'.format(pip.format('torch==1.1.0 torchvision==0.3.0 -f {}'.format(url))))
    print(LINES)
    print('tensorflow(tft):')
    print('\tcpu:')
    print('\t\t{}'.format(pip.format('tensorflow # cpu only')))
    print('\tgpu cuda 9.1:')
    print('\t\t{}'.format(pip.format('tensorflow-gpu==1.12')))
    print('\tgpu cuda>=10:')
    print('\t\t{}'.format(pip.format('tensorflow-gpu')))
    print('\tfor more versions:')
    ...
    print('tflite(tflt):')
    print('\twindows 10:')
    print('\t\t{}'.format(pip.format('--extra-index-url https://google-coral.github.io/py-repo/ tflite_runtime')))
    print(LINES)
    return
