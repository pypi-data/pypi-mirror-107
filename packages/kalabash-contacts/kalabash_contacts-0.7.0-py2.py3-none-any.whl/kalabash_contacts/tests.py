...
class AddressBookViewSetTestCase(TestDataMixin, KaldelaAPITestCase):
...
class CategoryViewSetTestCase(TestDataMixin, KaldelaAPITestCase):
...
class ContactViewSetTestCase(TestDataMixin, KaldelaAPITestCase):
...
class EmailAddressViewSetTestCase(TestDataMixin, KaldelaAPITestCase):
