...
def detectBlur(img, downsampling_factor=4, num_scales=4, scale_start=3, entropy_filt_kernel_sze=7, sigma_s_RF_filter=15, sigma_r_RF_filter=0.25, num_iterations_RF_filter=3):
    blur_detector_object = BlurDetector(downsampling_factor, num_scales, scale_start, entropy_filt_kernel_sze, sigma_s_RF_filter, sigma_r_RF_filter, num_iterations_RF_filter)  # Create object called image_enhancer
