...
setuptools.setup(
    ...
    install_requires=['Pillow == 5.4.1', 'pyyaml == 5.3.1','shapely == 1.7','wxpython == 4.0.4',
			  ...
			  'plotly == 4.9.0', 'statsmodels == 0.9.0', 'cefpython3 == 66.0', "pyarrow == 0.17.1", "shap == 0.35.0","h5py==2.9.0",'deeplabcut == 2.0.8','deepposekit == 0.3.5',
               'tensorflow-gpu == 1.14.0', 'protobuf == 3.6.0'],
