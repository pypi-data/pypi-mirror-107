...
from .base import RichHelpMixing
...
class CreateNamespace(RichHelpMixing, ShowOne):
    """Create Namespace."""
...
class ListNamespace(RichHelpMixing, Lister):
    """List namespaces"""
    help_file = 'namespace.txt'
...
class ShowNamespace(RichHelpMixing, ShowOne, NamespaceFetchMixin):
    """Show server details."""
    help_file = 'namespace.txt'
...
class SelectNamespace(RichHelpMixing, ShowOne, NamespaceFetchMixin):
    """Select Namespace."""
    help_file = 'namespace.txt'
...
class CurrentNamespace(RichHelpMixing, ShowOne):
