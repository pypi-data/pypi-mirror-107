...
```
usage: hdev [-h] [--project-dir PROJECT_DIR] [--debug] {alembic,clean,deps,install-python,python_version,requirements,run,template} ...

positional arguments:
  {alembic,clean,deps,install-python,python_version,requirements,run,template}
