...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '4.5.0-alpha.1622117305+0f92558b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 4.5.0-alpha.1622117305+0f92558b`
                """)
            else:
                raise
