...
class KubernetesCompute(ComputeTarget):
    """KubernetesCompute is a customer managed K8s cluster, which can be attached to a workspace by cluster admin.
    ...
    @staticmethod
    def attach_configuration(resource_id=None, aml_k8s_config={}):
        """Create a configuration object for attaching an compute target.

        :param resource_id: The resource id.
        :type resource_id: str
        :param aml_k8s_config: A dictonary of implementation specifying attach options.
        :type aml_k8s_config: dict
        ...
        """
        config = KubernetesComputeAttachConfiguration(resource_id, aml_k8s_config)
        return config
    ...
    def refresh_state(self):
        ...
        self.aml_k8s_config = compute_target.aml_k8s_config
    ...
    def serialize(self):
        ...
        cluster_properties = {'computeType': self.type, 'computeLocation': self.cluster_location,
                              ...
                              'properties': {'amlK8sConfig': self.aml_k8s_config},
    ...
    def _initialize(self, workspace, obj_dict):
        ...
        self.status = status
        self.aml_k8s_config = obj_dict['properties']['properties'].get(
            'amlK8sConfig')
...
class KubernetesComputeAttachConfiguration(ComputeTargetAttachConfiguration):
    ...
    def __init__(self, resource_id=None, aml_k8s_config=None):
        """Initialize the configuration object."""
        super(KubernetesComputeAttachConfiguration, self).__init__(KubernetesCompute)
        self.resource_id = resource_id
        self.aml_k8s_config = aml_k8s_config
