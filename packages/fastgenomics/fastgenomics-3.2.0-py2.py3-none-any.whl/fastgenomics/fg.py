...
class FASTGenomicsLargeFileStorageClient(FASTGenomicsClient):
    ...
    def __create_dataset_and_attach_lfs(self, sai: LargeFileStorageAccessInformation, title: str, dataset_type: str = "cs-singlecell") -> str:
...
class FASTGenomicsDatasetClient(FASTGenomicsClient):
    ...
    def create_dataset(self, title: str, dataset_type: str) -> requests.Response:
