...
from bridge_utils.pbn2html.pbn2html import get_from_pbn_file, pbn_html_all
...
def get_pbn_html(url):
    ...
    pbn_table = pbn_html_all(pbn)
    pbn_html = "<table class='TableFrame_blank1px' align='center' cellspacing='0px' cellpadding='6px'>" + pbn_table + "</table>"
    return pbn_html
