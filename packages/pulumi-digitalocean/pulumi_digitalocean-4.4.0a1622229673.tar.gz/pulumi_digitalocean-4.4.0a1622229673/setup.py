...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '4.4.0-alpha.1622229673+7bd71fd9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 4.4.0-alpha.1622229673+7bd71fd9`
                """)
            else:
                raise
