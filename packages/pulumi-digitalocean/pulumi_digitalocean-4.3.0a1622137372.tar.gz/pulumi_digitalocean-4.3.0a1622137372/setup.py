...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '4.3.0-alpha.1622137372+7d6f2344'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 4.3.0-alpha.1622137372+7d6f2344`
                """)
            else:
                raise
