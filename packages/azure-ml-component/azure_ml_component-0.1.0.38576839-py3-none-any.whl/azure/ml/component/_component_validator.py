...
class ComponentValidator(object):
    ...
    @staticmethod
    def _validate_compute_target(compute_name, spec, workspace, process_error) -> str:
    ...
    def _validate_runsetting_parameter(param_value, spec: _RunSettingsInterfaceParam, process_error,
        ...
        if spec.is_compute_target and not skip_compute_validation and workspace is not None:
            ComponentValidator._validate_compute_target(param_value, spec, workspace, process_error)
        ...
        for output in output_interfaces:
            ...
            if port._datastore_name is not None and port.datastore is None:
                process_error(
                    ...
                    ComponentValidationError.DATASTORE_NOT_EXIST, port._datastore_name, VariableType.Datastore)
            ...
            for output in output_interfaces:
                ...
                if not isinstance(datastore, AzureDataLakeDatastore):
                    process_error(
                        ...
                        ComponentValidationError.INVALID_DATASTORE_TYPE, datastore_name, VariableType.Datastore)
