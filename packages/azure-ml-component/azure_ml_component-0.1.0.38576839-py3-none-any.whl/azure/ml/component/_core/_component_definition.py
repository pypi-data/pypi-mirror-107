...
class PipelineComponentDefinition(ComponentDefinition):
    ...
    def __init__(self, id, name, components: dict, components_variable_names=None, description=None, version=None,
                 display_name=None, inputs=None, outputs=None, parameters=None, workspace=None,
        ...
        super().__init__(
            ...
            tags=tags, snapshot_id=snapshot_id)
