...
class Pipeline(Component, Visible, WorkspaceTelemetryMixin):
    ...
    def validate(self, raise_error=False, is_local=False):
        ...
        if can_visualize:
            ...
            graphyaml = self._build_visualization_dict(visualization_context, is_local=is_local)
    ...
    @timer()
    def _build_visualization_dict(self, visualization_context, skip_validation=False, is_local=False):
