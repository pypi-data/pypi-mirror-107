...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azuredevops', '2.1.0-alpha.1622118563+68a2d775'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azuredevops 2.1.0-alpha.1622118563+68a2d775`
                """)
            else:
                raise
