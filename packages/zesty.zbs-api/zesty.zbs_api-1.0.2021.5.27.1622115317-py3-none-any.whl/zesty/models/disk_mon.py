from src.models.hf_interface import IDeviceHF
...
class FileSystem:
    def __init__(self, fs_data, fs_id, cloud_vendor):
        self.cloud_vendor = cloud_vendor
        self.fs_id = fs_id
    ...
    class BlockDevice(IDeviceHF):
        def __init__(self, block_device_data, cloud_vendor):
            self.cloud_vendor = cloud_vendor
