...
class Delivery:
    ...
    def get_label(self, out_type=1):
        ...
        :return: data
        """
        return self.dpd._get_label(self, out_type)

    def save_pdf_label(self, out_path, filename, margins=[20, 20, 20, 20], paper_size="A4", zoom=1):
        """
        ...
        margins = [x * 254 for x in margins]

        # get wkhtmltopdf options
        options = {'page-size': paper_size,
                   'margin-top': f'{margins[0]}in',
                   'margin-right': f'{margins[2]}in',
                   'margin-bottom': f'{margins[3]}in',
                   'margin-left': f'{margins[4]}in',
                   '--quiet': ''
                   }
            ...
            "consignment": [
                {
                    ...
                    "collectionDetails": {
                        ...
                        "address": {
                            ...
                            "town": self.sender_address.address_3 if self.sender_address.address_3 else self.sender_address.address_2,
                            "county": self.sender_address.address_4 if self.sender_address.address_4 else self.sender_address.address_2,
                        }
                    },
                    "deliveryDetails": {
                        "contactDetails": {
                        ...
                        "address": {
                            ...
                            "town": parcel.address_3 if parcel.address_3 else parcel.address_2,
