...
def main():
    ...
    parser_run.add_argument('-cad', '--cad', '-cadence', '--cadence', 
                            dest='cadence',
    ...
    parser_run.add_argument('-nyq', '--nyq', '-nyquist', '--nyquist', 
                            dest='nyquist',
...
#    )
    ...
    # Run pySYD
    parser_parallel = sub_parser.add_parser('parallel', parents=[parser_run],
                                            description='Run pySYD in parallel')
