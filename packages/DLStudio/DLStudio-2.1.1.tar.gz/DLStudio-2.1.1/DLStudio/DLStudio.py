...
__date__      = '2021-May-31'   
__url__       = 'https://engineering.purdue.edu/kak/distDLS/DLStudio-2.1.1.html'
...
@tag2_adversarial
    ...
    in the AdversarialLearning class.
    ...
    scripts in the ExamplesAdversarialLearning directory of the distro:
