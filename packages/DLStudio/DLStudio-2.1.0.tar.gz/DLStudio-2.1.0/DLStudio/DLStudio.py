...
CHANGE LOG:
  ...
  Version 2.1.0:
    ...
    class.  The name of the new class is Seq2SeqNetworks and it resides at
...
@tag2_seq2seq
    ...
    level in the distribution) named Seq2SeqNetworks that consists of the
    ...
    The following two scripts in the ExamplesSeq2SeqNetworks directory are 
...
CO-CLASSES OF THE MODULE:
    ...
    "datasets_for_AdversarialNetworks.tar.gz" that is provided under the link
    "Download the image dataset for AdversarialNetworks" at the top of the
    ...
    Seq2SeqNetworks contains the following two inner classes for illustrating
    seq2seq:
    ...
    would be the following scripts in the ExamplesSeq2SeqNetworks directory:
...
ExamplesSeq2SeqNetworks DIRECTORY:

    The ExamplesSeq2SeqNetworks directory of the distribution contains the
