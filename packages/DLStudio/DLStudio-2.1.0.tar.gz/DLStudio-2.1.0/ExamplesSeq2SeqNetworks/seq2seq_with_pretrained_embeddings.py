...
s2s = Seq2SeqNetworks.Seq2SeqWithPretrainedEmbeddings(
                                 dl_studio = dls,
                                 dataroot = dataroot,
...
encoder = Seq2SeqNetworks.Seq2SeqWithPretrainedEmbeddings.EncoderRNN(
                        dls,
                        s2s,
                        embedding_size = embedding_size,
...
decoder = Seq2SeqNetworks.Seq2SeqWithPretrainedEmbeddings.DecoderRNN(
                        dls,
                        s2s,
                        embedding_size = embedding_size,
                        hidden_size = hidden_size,
