...
/* harmony import */ var _style_icons_folder_open_svg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../style/icons/folder-open.svg */ "./style/icons/folder-open.svg");
...
const folderOpenIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_5__.LabIcon({
    name: 'ui-components:folder-open',
    svgstr: _style_icons_folder_open_svg__WEBPACK_IMPORTED_MODULE_6__.default
});
/**
 * A filetree renderer.
 */
class FileTreeRenderer extends _jupyterlab_filebrowser__WEBPACK_IMPORTED_MODULE_4__.DirListing.Renderer {
    constructor(model) {
        super();
        this.model = model;
    }
    ...
    updateItemNode(node, model, fileType, translator, hiddenColumns) {
        ...
        if (model.type === 'directory' && this.model.isOpen(model)) {
            const iconContainer = _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.DOMUtils.findElement(node, 'jp-DirListing-itemIcon');
            _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_5__.LabIcon.resolveElement({
                icon: folderOpenIcon,
                iconClass: (0,_jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_5__.classes)('jp-Icon'),
 ...
 */
class DirTreeListing extends _jupyterlab_filebrowser__WEBPACK_IMPORTED_MODULE_4__.DirListing {
    constructor(options) {
    ...
    async handleFileSelect(event) {
        ...
        if (Object.keys(this.selection).length === 1) {
            ...
            if (isDirectory) {
                ...
                this.model.path = '/' + _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_3__.PathExt.dirname(selection);
            }
        }
    }
}
 ...
 */
class FilterFileTreeBrowserModel extends _jupyterlab_filebrowser__WEBPACK_IMPORTED_MODULE_4__.FilterFileBrowserModel {
    constructor(options) {
        super(options);
        this._isRestored = new _lumino_coreutils__WEBPACK_IMPORTED_MODULE_1__.PromiseDelegate();
 ...
 */
class FileTreeBrowser extends _jupyterlab_filebrowser__WEBPACK_IMPORTED_MODULE_4__.FileBrowser {
    constructor(options) {
        super(options);
...
//# sourceMappingURL=lib_index_js.4b2586b57d33e8029945.js.map