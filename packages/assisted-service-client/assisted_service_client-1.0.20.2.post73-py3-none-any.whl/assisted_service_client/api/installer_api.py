...
class InstallerApi(object):
    ...
    def download_cluster_iso_clone(self, cluster_id, **kwargs):  # noqa: E501
        """download_cluster_iso_clone  # noqa: E501

        Downloads the OpenShift per-cluster Discovery ISO. Provided for compatability with Dell IDRAC.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.download_cluster_iso_clone(cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.download_cluster_iso_clone_with_http_info(cluster_id, **kwargs)  # noqa: E501
        else:
            (data) = self.download_cluster_iso_clone_with_http_info(cluster_id, **kwargs)  # noqa: E501
            return data

    def download_cluster_iso_clone_with_http_info(self, cluster_id, **kwargs):  # noqa: E501
        """download_cluster_iso_clone  # noqa: E501

        Downloads the OpenShift per-cluster Discovery ISO. Provided for compatability with Dell IDRAC.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.download_cluster_iso_clone_with_http_info(cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method download_cluster_iso_clone" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_id' is set
        if ('cluster_id' not in params or
                params['cluster_id'] is None):
            raise ValueError("Missing the required parameter `cluster_id` when calling `download_cluster_iso_clone`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/clusters/{cluster_id}/downloads/image.iso', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def download_cluster_iso_headers_clone(self, cluster_id, **kwargs):  # noqa: E501
        """download_cluster_iso_headers_clone  # noqa: E501

        Downloads the OpenShift per-cluster Discovery ISO Headers only.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.download_cluster_iso_headers_clone(cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.download_cluster_iso_headers_clone_with_http_info(cluster_id, **kwargs)  # noqa: E501
        else:
            (data) = self.download_cluster_iso_headers_clone_with_http_info(cluster_id, **kwargs)  # noqa: E501
            return data

    def download_cluster_iso_headers_clone_with_http_info(self, cluster_id, **kwargs):  # noqa: E501
        """download_cluster_iso_headers_clone  # noqa: E501

        Downloads the OpenShift per-cluster Discovery ISO Headers only.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.download_cluster_iso_headers_clone_with_http_info(cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method download_cluster_iso_headers_clone" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_id' is set
        if ('cluster_id' not in params or
                params['cluster_id'] is None):
            raise ValueError("Missing the required parameter `cluster_id` when calling `download_cluster_iso_headers_clone`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/clusters/{cluster_id}/downloads/image.iso', 'HEAD',
            path_params,
            query_params,
            header_params,
            body=body_params,
