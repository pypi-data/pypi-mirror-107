...
def get_bundles_in_ug(base_url, mac_id, mac_token, host, ugid):
    ...
    for item in bundles['Entities']:
        ...
        active = item["Active"]
        bundles_dict.update({description.strip() : {'bundle_id': bundle_id,
...
def download(ctx, package):
    ...
    if package in package_type_dict.keys():
        ...
        first_five_bundles = take(5, bundles.items())
        ...
        # TODO query package type within  a bundle id to get the package and then download it
        ...
        if len(pacakges_clump) > 1:
            ...
            for item in pacakges_clump:
                ...
                if full_or_delta in download_url:
