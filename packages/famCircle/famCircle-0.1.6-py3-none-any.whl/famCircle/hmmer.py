...
class hmmer():
    ...
    def runhmm(self, hmmmold, path):
        ...
        m1 = hmmsearch + ' --domtblout one.out ' + hmmmold + ' ' + self.pep
        ...
        if (self.comparison == "clustal"):
            self.clustalw_path = self.clustalw_path + "clustalw"
        ...
        d = os.system(m2)# 格式转换
        # print(m2)
        m3 = hmmsearch + ' --domtblout ./out_list/' + name0 + '.out ./out_hmm/' + name0 + '.hmm ' + self.pep
        # x = input()##################
