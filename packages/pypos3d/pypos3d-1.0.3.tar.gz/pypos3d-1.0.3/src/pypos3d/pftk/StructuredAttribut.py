...
from pypos3d.pftk.SimpleAttribut import KSA, ValueOpDelta, OffSA, TextureMapSA,\
  SimpleAttribut
...
class PoserMaterial(StructuredAttribut):
  ...
  def __init__(self, src=None):
    ...
    if src:
      self.setPoserType(PoserToken.E_material)
  ...
  def write(self, fw, pfx):
    ...
    nextPfx = pfx + "\t"
    fw.write(nextPfx + "{\n")
    fw.write(nextPfx + 'KdColor {:f} {:f} {:f} {:f}\n'.format(self._KdColor.r, self._KdColor.g, self._KdColor.b, self._KdColor.t)) 
    fw.write(nextPfx + 'KaColor {:f} {:f} {:f} {:f}\n'.format(self._KaColor.r, self._KaColor.g, self._KaColor.b, self._KaColor.t)) 
    fw.write(nextPfx + 'KsColor {:f} {:f} {:f} {:f}\n'.format(self._KsColor.r, self._KsColor.g, self._KsColor.b, self._KsColor.t)) 
    fw.write(nextPfx + 'TextureColor {:g} {:g} {:g} {:g}\n'.format(self._TextureColor.r, self._TextureColor.g, self._TextureColor.b, self._TextureColor.t)) 

    fw.write(nextPfx + 'NsExponent {:f}\n'.format(self._NsExponent)) 
    fw.write(nextPfx + 'tMin {:f}\n'.format(self._tMin)) 
    fw.write(nextPfx + 'tMax {:f}\n'.format(self._tMax)) 
    fw.write(nextPfx + 'tExpo {:f}\n'.format(self._tExpo)) 
    fw.write(nextPfx + 'bumpStrength {:f}\n'.format(self._bumpStrength)) 
    fw.write(nextPfx + 'ksIgnoreTexture {:d}\n'.format(self._ksIgnoreTexture)) 
    fw.write(nextPfx + 'reflectThruLights {:d}\n'.format(self._reflectThruLights)) 
    fw.write(nextPfx + 'reflectThruKd {:f}\n'.format(self._reflectThruKd)) 
    ...
    fw.write(nextPfx + 'ReflectionColor {:f} {:f} {:f} {:f}\n'.format(self._ReflectionColor.r, self._ReflectionColor.g, self._ReflectionColor.b, self._ReflectionColor.t)) 
    fw.write(nextPfx + 'reflectionStrength {:f}\n'.format(self._reflectionStrength)) 
