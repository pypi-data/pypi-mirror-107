...
from notecron.center.app.scheduler import CuBackgroundScheduler
...
def create_app(config_name='production'):
    ...
    from notecron.center.app.main import main as main_blueprint
    app.register_blueprint(main_blueprint)

    # 接口对接
    from notecron.center.app.api import api as apis_bl
