...
def configs(key=None):
    ...
    # 'sqlite:///'+app.db_file('cron.sqlite')
    cron_db_url = 'sqlite:////root/workspace/tmp/notecron/databases/cron.sqlite'

    # 'sqlite:///'+app.db_file('db.sqlite')
    cron_job_log_db_url = 'sqlite:////root/workspace/tmp/notecron/databases/db.sqlite'
