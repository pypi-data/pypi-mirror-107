...
def configs(key=None):
    ...
    cron_db_url = 'sqlite:////notechats/apps/notecron/databases/cron.sqlite'  # 'sqlite:///'+app.db_file('cron.sqlite')
    # 'sqlite:///'+app.db_file('db.sqlite')
    cron_job_log_db_url = 'sqlite:////notechats/apps/notecron/databases/db.sqlite'
