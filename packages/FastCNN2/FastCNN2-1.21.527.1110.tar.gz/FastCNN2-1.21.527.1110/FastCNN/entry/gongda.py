...
if os.path.exists("./debug"):
    ...
    debug = True
from FastCNN.prx.GongDaProxy import predictPicture,predictSingle,predict,train,predictDirectory
"""
function below
--------------------------
"""
...
def callTrain():
    ...
    if modeltag:
        ...
        print("modeltag can not be null on train process")
