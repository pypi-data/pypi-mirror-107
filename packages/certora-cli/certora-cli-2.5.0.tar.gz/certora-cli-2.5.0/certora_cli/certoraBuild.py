...
class CertoraBuildGenerator:
    ...
    def collect_for_file(self, build_arg_contract_file: str,
        ...
        file_abs_path = as_posix(os.path.abspath(build_arg_contract_file))
    ...
    def build(self) -> None:
        for i, build_arg_contract_file in enumerate(sorted(self.input_config.files)):
            ...
            f_abs_path = os.path.abspath(build_arg_contract_file)
            new_file_abs_path = os.path.abspath(new_file)
