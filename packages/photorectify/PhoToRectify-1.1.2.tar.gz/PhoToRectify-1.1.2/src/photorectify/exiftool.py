...
class ExifTool(object):
    ...
    def start(self):
        ...
        2020-06-06: Removed ``-n`` in order to get LensID as a name.
        """
        if self.running:
    ...
    def copy_tags(self, from_filename, to_filename):
        """Copy tags from one file to other file."""
        self.execute(b"-TagsFromFile", from_filename, b"-all:all", b"-overwrite_original", to_filename)
