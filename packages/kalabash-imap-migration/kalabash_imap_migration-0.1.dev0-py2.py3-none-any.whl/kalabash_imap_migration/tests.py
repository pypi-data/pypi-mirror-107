...
class ViewsTestCase(DataMixin, KaldelaTestCase):
    """Views test cases."""
...
class AuthenticationTestCase(DataMixin, KaldelaTestCase):
...
class ManagementCommandTestCase(DataMixin, KaldelaTestCase):
...
class ViewSetTestCase(DataMixin, KaldelaAPITestCase):
...
class ChecksTestCase(KaldelaTestCase):
