...
class Version:
    ...
    metadata: Union[Unset, VersionMetadata] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, VersionMetadata]
        ...
        chunk_timestamp: Union[Unset, datetime.datetime]
        if isinstance(_chunk_timestamp, Unset):
            chunk_timestamp = UNSET
        else:
