...
T = TypeVar("T", bound="BodyPutUserAccountApiV1UsersImportPost")


@attr.s(auto_attribs=True)
class BodyPutUserAccountApiV1UsersImportPost:
    """  """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        body_put_user_account_api_v1_users_import_post = cls(
            excel=excel,
        )
