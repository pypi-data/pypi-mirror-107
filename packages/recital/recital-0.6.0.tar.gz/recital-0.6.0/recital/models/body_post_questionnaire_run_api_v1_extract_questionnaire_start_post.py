...
T = TypeVar("T", bound="BodyPostQuestionnaireRunApiV1ExtractQuestionnaireStartPost")


@attr.s(auto_attribs=True)
class BodyPostQuestionnaireRunApiV1ExtractQuestionnaireStartPost:
    """  """
    ...
    def to_dict(self) -> Dict[str, Any]:
        excel_questions: Union[Unset, Tuple[Optional[str], Union[BinaryIO, TextIO], Optional[str]]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        excel_questions: Union[Unset, File]
        if isinstance(_excel_questions, Unset):
            excel_questions = UNSET
        else:
