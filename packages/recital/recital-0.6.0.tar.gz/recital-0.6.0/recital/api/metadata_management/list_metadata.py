...
def _get_kwargs(
    *,
    ...
    json_value_type: Union[Unset, str] = UNSET
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HTTPValidationError, List[MetadataOut], None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[HTTPValidationError, List[MetadataOut], None]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    source: Union[Unset, MetadataSource] = UNSET,
    value_type: Union[Unset, MetadataType] = UNSET,
) -> Response[Union[HTTPValidationError, List[MetadataOut], None]]:
    kwargs = _get_kwargs(
        client=client,
        org_id=org_id,
        limit=limit,
...
def sync(
    *,
    ...
    source: Union[Unset, MetadataSource] = UNSET,
    value_type: Union[Unset, MetadataType] = UNSET,
) -> Optional[Union[HTTPValidationError, List[MetadataOut], None]]:
