...
def _get_kwargs(
    *,
    ...
    json_pages: Union[Unset, List[int]] = UNSET
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HTTPValidationError, List[ChunkOut], None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[HTTPValidationError, List[ChunkOut], None]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    limit: Union[Unset, int] = 100,
    offset: Union[Unset, int] = 0,
) -> Response[Union[HTTPValidationError, List[ChunkOut], None]]:
    kwargs = _get_kwargs(
        client=client,
...
def sync(
    *,
    ...
    limit: Union[Unset, int] = 100,
    offset: Union[Unset, int] = 0,
) -> Optional[Union[HTTPValidationError, List[ChunkOut], None]]:
