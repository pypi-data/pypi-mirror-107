...
def _parse_response(*, response: httpx.Response) -> Optional[Union[DocCount, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[DocCount, None]]:
    return Response(
