...
def _parse_response(*, response: httpx.Response) -> Optional[Union[ExtractTaskOut, HTTPValidationError, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[ExtractTaskOut, HTTPValidationError, None]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    json_body: ExtractTaskCreate,
    model_id: Union[Unset, int] = UNSET,
) -> Response[Union[ExtractTaskOut, HTTPValidationError, None]]:
    kwargs = _get_kwargs(
        client=client,
        json_body=json_body,
        model_id=model_id,
...
def sync(
    *,
    ...
    json_body: ExtractTaskCreate,
    model_id: Union[Unset, int] = UNSET,
) -> Optional[Union[ExtractTaskOut, HTTPValidationError, None]]:
