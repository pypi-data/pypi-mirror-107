...
def _parse_response(*, response: httpx.Response) -> Optional[Union[FileItemOut, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[FileItemOut, None]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    file_id: int,
    json_body: FileItemRename,
) -> Response[Union[FileItemOut, None]]:
    kwargs = _get_kwargs(
        client=client,
        file_id=file_id,
        json_body=json_body,
...
def sync(
    *,
    ...
    file_id: int,
    json_body: FileItemRename,
) -> Optional[Union[FileItemOut, None]]:
    """Rename a file item.
