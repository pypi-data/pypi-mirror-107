...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HTTPValidationError, List[str], None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[HTTPValidationError, List[str], None]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    query: str,
    suggestions: Union[Unset, int] = 10,
) -> Response[Union[HTTPValidationError, List[str], None]]:
    kwargs = _get_kwargs(
        client=client,
        query=query,
        suggestions=suggestions,
...
def sync(
    *,
    ...
    query: str,
    suggestions: Union[Unset, int] = 10,
) -> Optional[Union[HTTPValidationError, List[str], None]]:
