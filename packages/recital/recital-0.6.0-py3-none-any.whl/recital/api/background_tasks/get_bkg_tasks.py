...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HTTPValidationError, List[BackgroundTaskOut], None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[HTTPValidationError, List[BackgroundTaskOut], None]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    limit: Union[Unset, int] = 100,
    offset: Union[Unset, int] = 0,
) -> Response[Union[HTTPValidationError, List[BackgroundTaskOut], None]]:
    kwargs = _get_kwargs(
        client=client,
        all_tasks=all_tasks,
        limit=limit,
...
def sync(
    *,
    ...
    limit: Union[Unset, int] = 100,
    offset: Union[Unset, int] = 0,
) -> Optional[Union[HTTPValidationError, List[BackgroundTaskOut], None]]:
