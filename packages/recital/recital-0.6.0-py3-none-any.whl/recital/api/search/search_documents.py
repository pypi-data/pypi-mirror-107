...
def _parse_response(*, response: httpx.Response) -> Optional[Union[None, SearchResultDocuments]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[None, SearchResultDocuments]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    limit: Union[Unset, int] = 100,
    offset: Union[Unset, int] = 0,
) -> Response[Union[None, SearchResultDocuments]]:
    kwargs = _get_kwargs(
        client=client,
        json_body=json_body,
        query_id=query_id,
...
def sync(
    *,
    ...
    limit: Union[Unset, int] = 100,
    offset: Union[Unset, int] = 0,
) -> Optional[Union[None, SearchResultDocuments]]:
