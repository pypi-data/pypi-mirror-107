...
def _parse_response(*, response: httpx.Response) -> Optional[Union[MetadataId, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[MetadataId, None]]:
    return Response(
...
def sync_detailed(
    *,
    client: AuthenticatedClient,
    json_body: DocSearchMetadata,
) -> Response[Union[MetadataId, None]]:
    kwargs = _get_kwargs(
        client=client,
        json_body=json_body,
    )
...
def sync(
    *,
    client: AuthenticatedClient,
    json_body: DocSearchMetadata,
) -> Optional[Union[MetadataId, None]]:
