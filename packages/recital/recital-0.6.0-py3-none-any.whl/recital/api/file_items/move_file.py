...
def _parse_response(*, response: httpx.Response) -> Optional[Union[FileItemOut, HTTPValidationError, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[FileItemOut, HTTPValidationError, None]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    file_id: int,
    json_body: FileItemMove,
) -> Response[Union[FileItemOut, HTTPValidationError, None]]:
    kwargs = _get_kwargs(
        client=client,
        file_id=file_id,
        json_body=json_body,
...
def sync(
    *,
    ...
    file_id: int,
    json_body: FileItemMove,
) -> Optional[Union[FileItemOut, HTTPValidationError, None]]:
    """Moves a file item.
