...
def _parse_response(*, response: httpx.Response) -> Optional[Union[List[ChunkOut], None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[List[ChunkOut], None]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    limit: Union[Unset, int] = 100,
    offset: Union[Unset, int] = 0,
) -> Response[Union[List[ChunkOut], None]]:
    kwargs = _get_kwargs(
        client=client,
        chunks_in=chunks_in,
        limit=limit,
...
def sync(
    *,
    ...
    limit: Union[Unset, int] = 100,
    offset: Union[Unset, int] = 0,
) -> Optional[Union[List[ChunkOut], None]]:
