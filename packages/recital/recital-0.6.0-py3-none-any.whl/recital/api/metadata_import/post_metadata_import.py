...
from ...models.body_post_metadata_import_api_v1_metadata_import_post import (
    BodyPostMetadataImportApiV1MetadataImportPost,
)
...
def _get_kwargs(
    *,
    ...
    multipart_data: BodyPostMetadataImportApiV1MetadataImportPost,
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HTTPValidationError, MetadataImportCreateOut, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[HTTPValidationError, MetadataImportCreateOut, None]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    multipart_data: BodyPostMetadataImportApiV1MetadataImportPost,
    org_id: Union[Unset, int] = UNSET,
) -> Response[Union[HTTPValidationError, MetadataImportCreateOut, None]]:
    kwargs = _get_kwargs(
        client=client,
...
def sync(
    *,
    ...
    multipart_data: BodyPostMetadataImportApiV1MetadataImportPost,
    org_id: Union[Unset, int] = UNSET,
) -> Optional[Union[HTTPValidationError, MetadataImportCreateOut, None]]:
