...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HTTPValidationError, MetadataImportOut, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[HTTPValidationError, MetadataImportOut, None]]:
    return Response(
...
def sync_detailed(
    *,
    client: AuthenticatedClient,
    metadata_import_id: int,
) -> Response[Union[HTTPValidationError, MetadataImportOut, None]]:
    kwargs = _get_kwargs(
        client=client,
...
def sync(
    *,
    client: AuthenticatedClient,
    metadata_import_id: int,
) -> Optional[Union[HTTPValidationError, MetadataImportOut, None]]:
