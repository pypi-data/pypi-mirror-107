...
def _parse_response(*, response: httpx.Response) -> Optional[Union[ExtractModelOut, HTTPValidationError, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[ExtractModelOut, HTTPValidationError, None]]:
    return Response(
...
def sync_detailed(
    *,
    client: AuthenticatedClient,
    model_id: int,
) -> Response[Union[ExtractModelOut, HTTPValidationError, None]]:
    kwargs = _get_kwargs(
        client=client,
        model_id=model_id,
    )
...
def sync(
    *,
    client: AuthenticatedClient,
    model_id: int,
) -> Optional[Union[ExtractModelOut, HTTPValidationError, None]]:
