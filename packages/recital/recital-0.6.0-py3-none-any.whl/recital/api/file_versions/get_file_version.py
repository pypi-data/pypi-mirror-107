...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HTTPValidationError, None, Version]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[HTTPValidationError, None, Version]]:
    return Response(
...
def sync_detailed(
    *,
    client: AuthenticatedClient,
    version_id: int,
) -> Response[Union[HTTPValidationError, None, Version]]:
    kwargs = _get_kwargs(
        client=client,
...
def sync(
    *,
    client: AuthenticatedClient,
    version_id: int,
) -> Optional[Union[HTTPValidationError, None, Version]]:
