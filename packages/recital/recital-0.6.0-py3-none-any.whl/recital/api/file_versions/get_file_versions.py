...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HTTPValidationError, List[Version], None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[HTTPValidationError, List[Version], None]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    item_id: int,
    only_indexed: Union[Unset, bool] = False,
) -> Response[Union[HTTPValidationError, List[Version], None]]:
    kwargs = _get_kwargs(
        client=client,
        item_id=item_id,
        only_indexed=only_indexed,
...
def sync(
    *,
    ...
    item_id: int,
    only_indexed: Union[Unset, bool] = False,
) -> Optional[Union[HTTPValidationError, List[Version], None]]:
