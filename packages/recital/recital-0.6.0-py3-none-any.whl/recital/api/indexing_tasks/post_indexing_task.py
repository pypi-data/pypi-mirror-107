...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HTTPValidationError, IndexingTaskOut, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[HTTPValidationError, IndexingTaskOut, None]]:
    return Response(
...
def sync_detailed(
    *,
    client: AuthenticatedClient,
    json_body: IndexingTaskCreate,
) -> Response[Union[HTTPValidationError, IndexingTaskOut, None]]:
    kwargs = _get_kwargs(
        client=client,
        json_body=json_body,
    )
...
def sync(
    *,
    client: AuthenticatedClient,
    json_body: IndexingTaskCreate,
) -> Optional[Union[HTTPValidationError, IndexingTaskOut, None]]:
