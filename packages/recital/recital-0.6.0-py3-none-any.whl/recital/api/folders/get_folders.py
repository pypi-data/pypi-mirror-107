...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HTTPValidationError, List[FolderOut], None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[HTTPValidationError, List[FolderOut], None]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    limit: Union[Unset, int] = 100,
    offset: Union[Unset, int] = 0,
) -> Response[Union[HTTPValidationError, List[FolderOut], None]]:
    kwargs = _get_kwargs(
        client=client,
        org_id=org_id,
        path=path,
...
def sync(
    *,
    ...
    limit: Union[Unset, int] = 100,
    offset: Union[Unset, int] = 0,
) -> Optional[Union[HTTPValidationError, List[FolderOut], None]]:
