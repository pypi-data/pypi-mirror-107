...
def _parse_response(*, response: httpx.Response) -> Optional[Union[FolderOut, HTTPValidationError, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[FolderOut, HTTPValidationError, None]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    json_body: FolderCreate,
    ignore_conflicts: Union[Unset, bool] = False,
) -> Response[Union[FolderOut, HTTPValidationError, None]]:
    kwargs = _get_kwargs(
        client=client,
        json_body=json_body,
        ignore_conflicts=ignore_conflicts,
...
def sync(
    *,
    ...
    json_body: FolderCreate,
    ignore_conflicts: Union[Unset, bool] = False,
) -> Optional[Union[FolderOut, HTTPValidationError, None]]:
