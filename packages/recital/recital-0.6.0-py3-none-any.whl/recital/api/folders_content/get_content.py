...
def _parse_response(*, response: httpx.Response) -> Optional[Union[ContentContentOut, HTTPValidationError, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[ContentContentOut, HTTPValidationError, None]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    limit: Union[Unset, int] = 100,
    offset: Union[Unset, int] = 0,
) -> Response[Union[ContentContentOut, HTTPValidationError, None]]:
    kwargs = _get_kwargs(
        client=client,
        folder_id=folder_id,
        limit=limit,
...
def sync(
    *,
    ...
    limit: Union[Unset, int] = 100,
    offset: Union[Unset, int] = 0,
) -> Optional[Union[ContentContentOut, HTTPValidationError, None]]:
