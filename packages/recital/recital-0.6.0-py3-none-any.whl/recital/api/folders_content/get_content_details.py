...
def _parse_response(*, response: httpx.Response) -> Optional[Union[ContentDetailsOut, HTTPValidationError, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[ContentDetailsOut, HTTPValidationError, None]]:
    return Response(
...
def sync_detailed(
    *,
    client: AuthenticatedClient,
    folder_id: int,
) -> Response[Union[ContentDetailsOut, HTTPValidationError, None]]:
    kwargs = _get_kwargs(
        client=client,
        folder_id=folder_id,
    )
...
def sync(
    *,
    client: AuthenticatedClient,
    folder_id: int,
) -> Optional[Union[ContentDetailsOut, HTTPValidationError, None]]:
