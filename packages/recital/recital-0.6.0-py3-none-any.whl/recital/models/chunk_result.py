...
class ChunkResult:
    ...
    metadata: Union[Unset, ChunkResultMetadata] = UNSET
    ...
    coordinates: Union[Unset, ChunkResultCoordinates] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        text = self.text
        image: Union[Unset, Tuple[Optional[str], Union[BinaryIO, TextIO], Optional[str]]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, ChunkResultMetadata]
        ...
        coordinates: Union[Unset, ChunkResultCoordinates]
