...
class MetadataDisplayOut:
    ...
    def to_dict(self) -> Dict[str, Any]:
        primary_filters: Union[Unset, List[Dict[str, Any]]] = UNSET
        ...
        secondary_filters: Union[Unset, List[Dict[str, Any]]] = UNSET
        ...
        chunks_results: Union[Unset, List[Dict[str, Any]]] = UNSET
        ...
        sorting_metadata: Union[Unset, List[Dict[str, Any]]] = UNSET
