...
'''
# will search for a MAXIMUM in a region with a certain center and withing an hypecube of a certain edge
def look_within(function, function_opposite, centre, edge=1e-6, parallel=True, strict=True):
	...
	while solution is None or not is_minimum:
		...
		testing = function.validateLocalMinimum(solution.values, strict=strict)
		print(testing)
