...
class OpaBoxProductView:
	def __init__(self, id: str,
						...
						view: List[OpaBoxProductViewPresentation] = None,
...
class OpaBoxProduct:
	def __init__(self, active: bool, 
						...
						category_label: str = '',
						price_cost: float = 0,
						presentations: List[OpaBoxProductPresentation] = None, 
						product_views: List[OpaBoxProductView] = None,
		...
		self.product_view_id = product_views        
		self.photos = photos
