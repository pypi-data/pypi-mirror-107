...
class DwfDevice:
    """The |DwfDevice| represents a single Digilent test and measurement device.
    ...
    def __init__(self, dwf: 'DwfLibrary', hdwf: int) -> None:
        ...
        This method is used by the |DwfLibrary.device.open| method to initialize a
        |DwfDevice| immediately after succesfully opening a Digilent device using the low-level C API.
