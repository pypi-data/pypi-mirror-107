"""The |pydwf.core.auciliary.exceptions| module implements the |PyDwfError| and |DwfLibraryError|
exception classes."""
...
class DwfLibraryError(PyDwfError):
    ...
    Attributes:
        ...
        msg (Optional[str]):
            ...
            It may contain multiple messages, separated by a newline character.
    """
