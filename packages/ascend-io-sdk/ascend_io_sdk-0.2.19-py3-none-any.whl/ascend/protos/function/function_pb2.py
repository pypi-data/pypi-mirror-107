...
_CODE_LANGUAGE = _descriptor.Descriptor(
  ...
  nested_types=[_CODE_LANGUAGE_PYTHON, _CODE_LANGUAGE_JAVA, _CODE_LANGUAGE_SQL, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
