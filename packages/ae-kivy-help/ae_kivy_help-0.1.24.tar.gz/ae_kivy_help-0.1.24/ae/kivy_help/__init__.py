...
The :class:`AnimatedTourMixin` can be mixed-into a tour class that inherits from :class:`~ae.gui_help.TourBase` for to
...
Finally, the class :class:`TourOverlay` is implementing a overlay layout widget for to display the animations, shaders,
