...
__all__ = [
    ...
    "transform_extrusion", "transform_thickness_and_extrusion_without_ocs"
]
...
def transform_thickness_and_extrusion_without_ocs(entity: 'DXFGraphic',
                                                  m: Matrix44) -> None:
...
class OCSTransform:
    ...
    def transform_2d_vertex(self, vertex: 'Vertex', elevation: float) -> Vec2:
        ...
        return self.new_ocs.from_wcs(
            self.m.transform(self.old_ocs.to_wcs(v))).vec2
