...
from pyLion.misc._decorators import *
from pyLion.misc._wrappers import *
...
ALIVE_NAME = Lion_bot.me.first_name
...
def sudo():
    def decorator(function):
        ...
        async def wrapper(event):
            if event.sender_id == Lion_bot.uid or is_sudo(event.sender_id):
...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Lion")
