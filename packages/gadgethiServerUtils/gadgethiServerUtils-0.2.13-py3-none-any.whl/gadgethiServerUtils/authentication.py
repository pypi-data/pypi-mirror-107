...
class GadgethiHMAC256Verification():
	...
	def hmac256_verification(self, secret, message):
		"""
		...
		"""
		encryption_result = self.HMAC256_digest(secret, message)
	...
	def gserver_authentication(self, message, time_shift=8,interval=30,secret='gadgethi'):
		"""
