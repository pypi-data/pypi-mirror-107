...
class cyborgfi(Exchange):

    def user_init(self, userConfig):
        base = self.get_key(userConfig, 'exchangeBaseUrl')
        if base is None:
            base = 'https://app.cyborg.fi:9010'
            userConfig['exchangeBaseUrl'] = base
        self.set_attrib(self, 'exchangeBaseUrl', base)

    def describe(self):
        return self.deep_extend(super(cyborgfi, self).describe(), {
            'id': 'cyborgfi',
            'name': 'CyborgFi',
            ...
            'urls': {
                ...
                'test': {
                    'dapiPublic': self.exchangeBaseUrl + '/dapi/v1',
                    'dapiPrivate': self.exchangeBaseUrl + '/dapi/v1',
                    'fapiPublic': self.exchangeBaseUrl + '/fapi/v1',
                    'fapiPrivate': self.exchangeBaseUrl + '/fapi/v1',
                    'fapiPrivateV2': self.exchangeBaseUrl + '/fapi/v2',
                    'public': self.exchangeBaseUrl + '/api/v3',
                    'private': self.exchangeBaseUrl + '/api/v3',
                    'v3': self.exchangeBaseUrl + '/api/v3',
                    'v1': self.exchangeBaseUrl + '/api/v1',
                },
                'api': {
                    'wapi': self.exchangeBaseUrl + '/wapi/v3',
                    'sapi': self.exchangeBaseUrl + '/sapi/v1',
                    'dapiPublic': self.exchangeBaseUrl + '/dapi/v1',
                    'dapiPrivate': self.exchangeBaseUrl + '/dapi/v1',
                    'dapiPrivateV2': self.exchangeBaseUrl + '/dapi/v2',
                    'dapiData': self.exchangeBaseUrl + '/futures/data',
                    'fapiPublic': self.exchangeBaseUrl + '/fapi/v1',
                    'fapiPrivate': self.exchangeBaseUrl + '/fapi/v1',
                    'fapiData': self.exchangeBaseUrl + '/futures/data',
                    'fapiPrivateV2': self.exchangeBaseUrl + '/fapi/v2',
                    'public': self.exchangeBaseUrl + '/api/v3',
                    'private': self.exchangeBaseUrl + '/api/v3',
                    'v3': self.exchangeBaseUrl + '/api/v3',
