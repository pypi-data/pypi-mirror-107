...
def to_json(xml_etree, xsd_annotated_schema):
    ...
    def build_types(exploded_annotated_schema_obj):
        simpletype_mappings = {}
        type_mappings = {
            "anyType":  "string",
            "anySimpleType":  "string",
    ...
    exploded_annotated_schema_obj = _explode_schema.main(xsd_annotated_schema)
    mappings = build_types(exploded_annotated_schema_obj)
