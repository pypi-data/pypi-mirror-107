...
class ResponseExperiment(object):
    ...
    def __init__(self, access_token_id=None, config_id=None, created_by_id=None, created_dt=None, exit_code=None, id=None, immutable_slug=None, kernel_cluster_id=None, kernel_cluster_node_id=None, message=None, metrics_summary=None, name=None, number=None, plot_volume_id=None, project_id=None, status=None, status_last_updated=None, status_reason=None, updated_dt=None, workspace_id=None, local_vars_configuration=None):  # noqa: E501
