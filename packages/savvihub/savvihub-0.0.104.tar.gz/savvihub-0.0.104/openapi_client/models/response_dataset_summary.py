...
class ResponseDatasetSummary(object):
    ...
    def __init__(self, created_by_id=None, created_dt=None, dataset_id=None, id=None, immutable_slug=None, summary=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
