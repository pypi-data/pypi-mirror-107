...
class ResponseSnapshot(object):
    ...
    def __init__(self, created_dt=None, description=None, file_count=None, id=None, immutable_slug=None, name=None, size=None, status=None, updated_dt=None, volume_id=None, workspace_id=None, local_vars_configuration=None):  # noqa: E501
