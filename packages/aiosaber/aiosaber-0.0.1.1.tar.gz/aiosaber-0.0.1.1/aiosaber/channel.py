...
from aiosaber.utility.target import END, End
...
class ChannelBase(object):
    ...
    def __getitem__(self, key) -> "Channel":
        ...
        """
        from aiosaber.operators import GetItem
    ...
    @classmethod
    def event(cls, *funcs, interval: float = 5, value=None, **kwargs) -> "EventChannel":
...
class EventChannel(AsyncChannel):
    ...
    def __init__(self, interval: float = 5, value=None, **kwargs):
        super().__init__(**kwargs)
