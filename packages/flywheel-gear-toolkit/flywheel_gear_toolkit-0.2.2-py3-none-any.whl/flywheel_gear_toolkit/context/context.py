...
from flywheel_gear_toolkit.utils import BytesEncoder
...
class GearToolkitContext:
    ...
    def log_metadata(self):
        log.info(
            ".metadata.json:\n%s",
            json.dumps(self._metadata, indent=2, cls=BytesEncoder),
        )
    ...
    def write_metadata(self):
        ...
        with self.open_output(".metadata.json") as f:
            json.dump(self._metadata, f, indent=2, cls=BytesEncoder)
