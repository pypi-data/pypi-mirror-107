...
@click.pass_context
def cmake_automoc_parser(ctx):
    return run('cmake_automoc_parser', args=ctx.args)
...
@click.pass_context
def qt_internal_configure_tests(ctx):
    return run('qt-internal-configure-tests', args=ctx.args)
