...
def download_list_vip(ID,permit):
    permit = str(permit)
    key = ['1241-1231-8952-4813','1949-4959-3859-3048','9493-4945-1935-9359']
    if permit in key:
        headers = {
...
def download_list(ID):
    ...
    for i in lists:
        ...
        try:
            print('正在下载',name)
            time.sleep(pylucky.number(60,300))
            urllib.request.urlretrieve(url,'./%s.mp3'% name)
            time.sleep(pylucky.number(60,300))
            print('下载成功')
            time.sleep(pylucky.number(40,200))
        except:
            print('下载失败')
