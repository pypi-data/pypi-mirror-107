...
# **delete_csr**
> delete_csr(csr_id, org_id=org_id, private_key_id=private_key_id)
...
# **get_csr**
> CertSigningReq get_csr(csr_id, org_id=org_id, private_key_id=private_key_id)
...
# **replace_csr**
> CertSigningReq replace_csr(csr_id, org_id=org_id, private_key_id=private_key_id, cert_signing_req=cert_signing_req)
