    ...
    def _solve(self):
        ...
        if quadObj:
            if self.ext.footprint.nonconvex_quadratic_objective:
                assert conTypes.issubset(set(
                    [DummyConstraint, AffineConstraint]))

                cplexType = cplexTypes.MIQP
            elif conTypes.issubset(set([DummyConstraint, AffineConstraint])):
