...
class TaskSection(CollapsibleSection):
    ...
    def resolve(self, expander, **kwargs):
        ...
        result.update(self._resolve_tasks(raw_template, main_sequence, scout_sequence, expander))
    ...
    def _resolve_tasks(self, template, main_sequence, scout_sequence, expander):
        ...
        for chunk in chunks:
            ...
            tasks.append({"command": this_expander.evaluate(template), "frames": str(chunk)})
