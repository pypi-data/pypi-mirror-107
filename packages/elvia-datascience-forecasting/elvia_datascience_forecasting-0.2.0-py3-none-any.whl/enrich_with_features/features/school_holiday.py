...
def school_holiday(df: pd.DataFrame,
    ...
    for station_id in df_holiday['trafo'].unique():
        ...
        station_region = df_holiday.loc[df_holiday['trafo'] ==
        ...
        frame = pd.DataFrame()
        frame['date'] = df_holiday.loc[df_holiday['trafo'] ==
                                       station_id].index.date

        # Checks if datetime is holiday and add True/False.
        df_holiday.loc[df_holiday['trafo'] == station_id,
