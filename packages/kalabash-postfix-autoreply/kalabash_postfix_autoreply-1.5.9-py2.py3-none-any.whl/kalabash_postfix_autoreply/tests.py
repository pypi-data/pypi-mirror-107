...
class EventsTestCase(KaldelaTestCase):
...
class FormTestCase(KaldelaTestCase):
...
class RepairTestCase(KaldelaTestCase):
    ...
    def test_management_command(self):
        ...
        management.call_command("kaldela", "repair", "--quiet")
        self.assertFalse(
            admin_models.AliasRecipient.objects.filter(
...
class ManagementCommandTestCase(KaldelaTestCase):
...
class ARMessageViewSetTestCase(KaldelaAPITestCase):
    """API test case."""
