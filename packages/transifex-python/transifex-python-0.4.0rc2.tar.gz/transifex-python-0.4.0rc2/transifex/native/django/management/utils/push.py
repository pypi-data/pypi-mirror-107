...
class Push(CommandMixin):
    def add_arguments(self, subparsers):
        ...
        parser.add_argument(
            '--append-tags', action='store_true', dest='append_tags',
            default='',
            help=('Append tags to strings when pushing to Transifex'),
        )
        parser.add_argument(
            '--with-tags-only', action='store_true', dest='with_tags_only',
            default='',
            help=('Push only strings that contain specific tags'),
        )
        parser.add_argument(
            '--without-tags-only', action='store_true',
            dest='without_tags_only', default='',
