...
class ConfigEngine(object):
    ...
    def save(self):
        ...
        rPath('used-config.json', fromPath='project.cache').dump(self.config)
...
class CfEngine(object):
    ...
    Raises:
        ex.NotInitConfig: Попытка обратиться к конфигурации без инициализации.
        ex.NotInitConfigFile: Попытка запросить именованный файл конфигурации без его обьявления.

    """

    core: ConfigEngine

    def __init__(self, core: ConfigEngine):
        """ Инициализация объекта

        Args:
            core (ConfigEngine): Ядро конфигурации, наследуемое от ConfigEngine

        """

        rtype.checker('core', core, [ConfigEngine])
    ...
    def get(self, dictPath: list, default: _T.Any = Exception) -> _T.Any:
        ...
        Raises:
            ex.NotInitConfig: Конфигурация приложения не была инициализирована.
        ...
        if self.core.prepared:
            ...
            raise ex.NotInitConfig from None
    ...
    def file(self, name: str) -> rPath:
        ...
        Raises:
            ex.NotInitConfigFile: Именованный файл не был инициализированн.
        ...
        try:
            ...
            raise ex.NotInitConfigFile(name) from None
