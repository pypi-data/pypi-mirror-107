...
class RootPaths(object):
    ...
    def init(self, userPath: pa.Path, projectPath: pa.Path, corePath: pa.Path):
        ...
        logger.debug(f'Конечные точки путей: {self.paths}')
...
class rPath(object):
    ...
    def parse(self) -> _T.Any:
        ...
        if self.extension == '.json':
            ...
            raise ex.DeveloperIsShitError('why?')
