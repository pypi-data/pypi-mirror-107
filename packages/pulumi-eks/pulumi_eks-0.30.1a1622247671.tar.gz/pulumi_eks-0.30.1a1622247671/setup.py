...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'eks', '0.30.1-alpha.1622247671+fbb5125a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource eks 0.30.1-alpha.1622247671+fbb5125a`
                """)
            else:
                raise
