...
OCEANUS_DATA_SERVICE_TMPL_RELPATH = os.path.join(
    TMPL_ROOT_DIR,
    "data-service",
    TMPL_DIR
)
...
def create(isfor_ms, isfor_ds):
    ...
    if isfor_ms:
        tmpl_path = OCEANUS_SERVICE_TMPL_RELPATH
    elif isfor_ds:
        tmpl_path = OCEANUS_DATA_SERVICE_TMPL_RELPATH
    else:
        tmpl_path = MODULE_TMPL_RELPATH
    project_template_path = os.path.join(workspace, tmpl_path)
