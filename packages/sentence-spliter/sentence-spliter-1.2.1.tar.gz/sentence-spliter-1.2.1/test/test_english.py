...
class test_spliter(unittest.TestCase):
    ...
    def test_bug_2021_4_2(self):
        ...
        expect = ['In his own farewell address, George Washington wrote that self-government is '
                  ...
                  'that we should preserve it with “jealous anxiety;”',
                  ' that we should reject “the first dawning of every attempt to alienate any '
    ...
    def test_bug_2021_4_3_1(self):
        ...
        __long_machine_en.run(m_input)
        acutal = m_input.sentence_list()
        expect = ["The show's writers gave these tropes a 2021 refresh by leaning into the \"woke\"",
                  ' culture of millennials and Gen Z, calling out intolerance, accepting and '
                  'normalising LGBTQ+ issues, and highlighting struggles faced by minorities '
                  'living in the US – African-Americans in particular.']
        self.assertEqual(expect, acutal)
    ...
    *Princess means the richest woman in the country."""
        ...
        expect = ['Lee Bo-jin is the second daughter of the chairman of Samsung, the "genuine" '
                  ...
                  ' With everything from money to power, Lee Bo-jin has always been dubbed the "No. 1 Korean woman"',
                  ' and ranked 87th in the top 100 most powerful women in the world voted by Forbes magazine.',
                  ' However, inside that flashy life is a tragic life of the "Samsung princess".',
                  ' *\n    *Princess means the richest woman in the country.']
    ...
    def test_bug_2021_4_6_9(self):
        ...
        expect = ['The night was rapidly approaching; and already, at the cry of “Moccoletti!”',
                  ' repeated by the shrill voices of a thousand vendors, two or three stars '
                  'began to burn among the crowd.',
