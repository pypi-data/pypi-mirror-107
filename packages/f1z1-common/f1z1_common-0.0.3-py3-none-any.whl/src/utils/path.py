...
from common.src.utils.strings import StringsUtil
from common.src.validator.is_validators import is_any_string, is_list, is_path
...
class PathUtil(object):
    ...
    @classmethod
    def is_endswith_ext(cls, path: PathTypes, ext_names: ExtensionNameList) -> bool:
        """
        is file by ext name
        :param path:
        :param ext_names:
