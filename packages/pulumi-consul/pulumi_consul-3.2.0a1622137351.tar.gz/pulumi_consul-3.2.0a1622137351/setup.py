...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '3.2.0-alpha.1622137351+519241d8'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 3.2.0-alpha.1622137351+519241d8`
                """)
            else:
                raise
