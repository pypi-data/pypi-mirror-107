...
class Embeddings(Module):
    def __init__(self, vocab_size: int, hidden_size: int, padding_idx: int, max_position_embeddings: int):
        super().__init__()
        self.word_embeddings = Embedding(vocab_size, hidden_size, padding_idx=padding_idx)
...
class MaskEmbeddings(Embeddings):
    def __init__(self, vocab_size: int, hidden_size: int, padding_idx: int, max_position_embeddings: int):
        super().__init__(vocab_size, hidden_size, padding_idx, max_position_embeddings)
