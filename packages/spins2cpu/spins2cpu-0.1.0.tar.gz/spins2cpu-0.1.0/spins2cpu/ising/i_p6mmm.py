...
def run(file, init, X, Y, J, arrays_temperatures, nequilibrium, nworks):
    ...
    if p == 2:
        ...
        if init == "fm":
            ...
            latt_2_0 = functions.Onesint(Y_s, X_s)
            latt_2_1 = functions.Onesint(Y_s, X_s)
            latt_2_2 = functions.Onesint(Y_s, X_s)
            latt_2_3 = functions.Onesint(Y_s, X_s)
            m_ave = functions.Average(latt_0_0 + latt_0_1 + latt_0_2 + latt_0_3 +
                                      latt_1_0 + latt_1_1 + latt_1_2 + latt_1_3 +
                                      latt_2_0 + latt_2_1 + latt_2_2 + latt_2_3) / 12.0
            ...
            for i in range(lav):
                t, Nw, Ew = i_p6mmm_update.iteration2(latt_0_0, latt_0_1, latt_0_2, latt_0_3,
                                                      latt_1_0, latt_1_1, latt_1_2, latt_1_3,
                                                      latt_2_0, latt_2_1, latt_2_2, latt_2_3,
            ...
            latt_2_2 = functions.Onesint(Y_s, X_s)
            latt_2_3 = functions.Onesint(Y_s, X_s)
            m_ave1 = functions.Average(latt_0_0 + latt_0_1 + latt_0_2 + latt_0_3 + latt_2_0 + latt_2_1 + latt_2_2 + latt_2_3) / 8.0
            ...
            latt_2_2 = -functions.Onesint(Y_s, X_s)
            latt_2_3 = -functions.Onesint(Y_s, X_s)
            m_ave1 = functions.Average(latt_0_0 + latt_0_1 + latt_1_0 + latt_1_1 + latt_2_0 + latt_2_1) / 6.0
            m_ave2 = functions.Average(latt_0_2 + latt_0_3 + latt_1_2 + latt_1_3 + latt_2_2 + latt_2_3) / 6.0
            logging.info("{:>16} {:>16.6} {:>16.6}".format(0, m_ave1, m_ave2))
            logging.info("{:>16} {:>16} {:>16} {:>16} {:>16} {:>16} {:>16}".format(
                "Temperature", "magnetism1", "magnetism2", "susceptibility1", "susceptibility2", "specific heat", "time(s)"))
            for i in range(lav):
                t, Nw, Ew = i_p6mmm_update.iteration2(latt_0_0, latt_0_1, latt_0_2, latt_0_3,
                                                      ...
                                                      latt_2_0, latt_2_1, latt_2_2, latt_2_3,
                                                      X_s, Y_s, Ja, J0, arrays_values[i], nequilibrium, nworks)
                arr_a, arr_b, arr_c, arr_d, arr_e, arr_f = np.hsplit(Nw,6)
                arr_a = np.hstack((arr_a, arr_c, arr_e))
                arr_b = np.hstack((arr_b, arr_d, arr_f))
                m_ave1 = functions.Average(arr_a)
                m_ave2 = functions.Average(arr_b)
                s_ave1 = functions.Average2(arr_a)
                s_ave2 = functions.Average2(arr_b)
            ...
            latt_2_2 = -functions.Onesint(Y_s, X_s)
            latt_2_3 = -functions.Onesint(Y_s, X_s)
            m_ave1 = functions.Average(latt_0_0 + latt_0_1 + latt_1_2 + latt_1_3 + latt_2_0 + latt_2_1) / 6.0
            m_ave2 = functions.Average(latt_0_2 + latt_0_3 + latt_1_0 + latt_1_1 + latt_2_2 + latt_2_3) / 6.0
            logging.info("{:>16} {:>16.6} {:>16.6}".format(0, m_ave1, m_ave2))
            logging.info("{:>16} {:>16} {:>16} {:>16} {:>16} {:>16} {:>16}".format(
                "Temperature", "magnetism1", "magnetism2", "susceptibility1", "susceptibility2", "specific heat", "time(s)"))
            for i in range(lav):
                t, Nw, Ew = i_p6mmm_update.iteration2(latt_0_0, latt_0_1, latt_0_2, latt_0_3,
                                                      ...
                                                      X_s, Y_s, Ja, J0, arrays_values[i], nequilibrium, nworks)
                arr_a, arr_b, arr_c, arr_d, arr_e, arr_f = np.hsplit(Nw,6)
                arr_a = np.hstack((arr_a, arr_d, arr_e))
                arr_b = np.hstack((arr_b, arr_c, arr_f))
                m_ave1 = functions.Average(arr_a)
                m_ave2 = functions.Average(arr_b)
                s_ave1 = functions.Average2(arr_a)
                s_ave2 = functions.Average2(arr_b)
        ...
        if init == "fm":
            ...
            logging.info("{:>16} {:>16} {:>16} {:>16} {:>16}".format("Temperature", "magnetism", "susceptibility", "specific heat", "time(s)"))
            for i in range(lav):
                t, Nw, Ew = i_p6mmm_update.iteration3(latt_0_0, latt_0_1, latt_0_2, latt_0_3,
                                                      latt_1_0, latt_1_1, latt_1_2, latt_1_3,
                                                      latt_2_0, latt_2_1, latt_2_2, latt_2_3,
