...
def run(file, init, X, Y, J, arrays_temperatures, nequilibrium, nworks):
    ...
    if p == 2:
        ...
        if init == "fm":
            ...
            for i in range(lav):
                t, Nw, Ew = p6mmm_update.iteration2(latt_0_0, latt_0_1, latt_0_2, latt_0_3, latt_1_0, latt_1_1, latt_1_2, latt_1_3,
            ...
            for i in range(lav):
                t, Nw, Ew = p6mmm_update.iteration2(latt_0_0, latt_0_1, latt_0_2, latt_0_3, latt_1_0, latt_1_1, latt_1_2, latt_1_3,
                                                    X_s, Y_s, Ja, J0, arrays_values[i], nequilibrium, nworks)
                arr_a, arr_b, arr_c, arr_d = np.hsplit(Nw,4)
                arr_a = np.hstack((arr_a, arr_d))
                arr_b = np.hstack((arr_b, arr_c))
                m_ave1 = functions.Average(arr_a)
                m_ave2 = functions.Average(arr_b)
                s_ave1 = functions.Average2(arr_a)
                s_ave2 = functions.Average2(arr_b)
        ...
        if init == "fm":
            ...
            logging.info("{:>16} {:>16} {:>16} {:>16} {:>16}".format("Temperature", "magnetism", "susceptibility", "specific heat", "time(s)"))
            for i in range(lav):
                t, Nw, Ew = p6mmm_update.iteration3(latt_0_0, latt_0_1, latt_0_2, latt_0_3, latt_1_0, latt_1_1, latt_1_2, latt_1_3,
