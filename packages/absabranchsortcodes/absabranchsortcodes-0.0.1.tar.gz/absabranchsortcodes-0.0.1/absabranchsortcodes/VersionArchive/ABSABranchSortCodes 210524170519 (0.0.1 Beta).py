...
class ABSABranchSortCodes:
    ...
    def test_func( self ):
        '''Method description
        '''
        print( colored( 'Testing ABSABranchSortCodes...', 'yellow' ))
        return True
    # end test_func
    ...
    def _renew_parameters( self ):
        ...
        self.proj_base_fldr = Path( sys.argv[ 0 ]).absolute().parents[ 2 ] / __mod_name__
        self.data_folder = self.proj_base_fldr / self._cfg.get( 'Folders', 'DataSubFolder' )
        create_folders()
...
if __name__ == '__main__':
    ...
    apputils = au.AppUtils( __name__, _version, __doc__, Path( sys.argv[ 0 ]), ini_pth )
