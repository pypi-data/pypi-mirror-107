...
def set_max_bounce_depth(diffuse_depth=2, glossy_depth=8, transparency_depth=8, transmission_depth=12, volume_depth=2):
    r"""
...
class entity(static_factory):
    ...
    def set_visibility(self, camera=True, diffuse=True, glossy=True, transmission=True, volume_scatter=True, shadow=True):
        r"""
    ...
    def get_center(self):
        r"""
        :rtype: :py:class:`vec3`
        :return: the average of the vertices of the mesh in world space, which will lay roughly in the center. Requires
            a transform and mesh component to be attached.
        """
        return _nvisii.entity_get_center(self)
...
def volume_create_box(*args, **kwargs):
    r"""
    Creates a sparse fog volume of a box such that the exterior
    is 0 and inactive, the interior is active with values varying
    smoothly from 0 at the surface of the box to 1 at the half width
...
class mesh(static_factory):
    ...
    def get_center(self):
        r"""
        :rtype: :py:class:`vec3`
        :return: the average of the vertices of the mesh, which will lay roughly in the center.
        """
        return _nvisii.mesh_get_center(self)
