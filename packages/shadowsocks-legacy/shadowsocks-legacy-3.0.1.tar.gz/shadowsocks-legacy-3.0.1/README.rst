...
This project is https://github.com/shadowsocks/shadowsocks clone.

I(hedon) didn't change any code. I downloaded the code from the original repo and 
created this package. The version number is 3.0.1 because I accidentally deleted 
the 3.0.0 release and I cannot upload 3.0.0 again to pypi.
...
::
    ...
    pip install shadowsocks-legacy
