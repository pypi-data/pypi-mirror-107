...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', '3.2.0-alpha.1622137378+3ca7dcdf'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip 3.2.0-alpha.1622137378+3ca7dcdf`
                """)
            else:
                raise
