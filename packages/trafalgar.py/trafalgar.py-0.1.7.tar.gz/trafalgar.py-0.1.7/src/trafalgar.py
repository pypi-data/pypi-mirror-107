...
def graph_close(stock, start_date, end_date, x=20,y=10):
...
def graph_open(stock, start_date, end_date,x=20, y=10):
...
def graph_volume(stock, start_date, end_date, x=20, y=10):
...
def graph_adj_close(stock, start_date, end_date, x=20, y=10):
...
def graph_corr(stocks, start_date, end_date, method="pearson", based_on = "returns", x=16, y=5):
  if based_on == "returns":
...
def graph_creturns(stock, wts, start_date, end_date,x,y):
  if len(stock) > 1:
...
def graph_rbenchmark(stocks, wts, benchmark, start_date, end_date, x=20, y=10):
...
# ------------------------------------------------------------------------------------------
def graph_cbenchmark(stocks, wts, benchmark, start_date, end_date, x=20, y=10):
  if len(stocks)>1 and len(wts)>1:
      price_data = web.DataReader(stocks, data_source='yahoo', start = start_date, end= end_date )
      price_data = price_data['Adj Close']
...
def correlation(stocks, start_date, end_date, method="pearson", based_on = "returns"):
  if based_on == "returns":
    df = web.DataReader(stocks, data_source='yahoo', start = start_date, end= end_date )['Close']
    returns = df.pct_change()
    corr_matrix = returns.corr(method=method)
...
def return_stationarity(stock, start_date, end_date):
  ...
  return check_for_stationarity(X)
#-------------------------------------------------------------------------------------------------------------------------
def graph_rvolatility(stock, wts, start_date, end_date, window_time=180,x=20, y=10):
  if len(stock)==1:
...
def graph_ralpha(stock,wts, benchmark, start_date, end_date, window_time=180, x=20, y=10):
...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------
def graph_rbeta(stock,wts, benchmark, start_date, end_date, window_time=180, x=20, y=10):
