...
def returns(stocks,wts, start_date, end_date=today):
  if len(stocks) > 1:
    ...
    return returns
#---------------------------------------------------------------------------------------------
def graph_returns(stock,wts, start_date, end_date, x=20, y=10):
  if len(stock) > 1:
...
def graph_creturns(stock, wts, start_date, end_date=today,x,y):
  if len(stock) > 1:
...
def creturns(stock, wts, start_date, end_date=today):
  if len(stock) > 1:
    price_data = web.DataReader(stock, data_source='yahoo', start = start_date, end= end_date )
    price_data = price_data['Adj Close']
...
def annual_volatility(stocks, wts, start_date, end_date=today):
  if len(stocks)>1:
...
def sharpe_ratio(stocks, wts, start_date, end_date=today):
  if len(stocks)>1:
    price_data = web.DataReader(stocks, data_source='yahoo', start = start_date, end= end_date )
    price_data = price_data['Adj Close']
...
def graph_rbenchmark(stocks, wts, benchmark, start_date, end_date=today, x=20, y=10):
  ...
  if len(stocks)>1 and len(wts)>1:
    ...
    ret_data.plot(figsize=(x,y))
#----------------------------------------------------------------------------------------
def rbenchmark(stocks, wts, benchmark, start_date, end_date=today):
...
def cbenchmark(stocks, wts, benchmark, start_date, end_date=today):
  if len(stocks)>1 and len(wts)>1:
      price_data = web.DataReader(stocks, data_source='yahoo', start = start_date, end= end_date )
      price_data = price_data['Adj Close']
...
# ------------------------------------------------------------------------------------------
def graph_cbenchmark(stocks, wts, benchmark, start_date, end_date=today, x=20, y=10):
  if len(stocks)>1 and len(wts)>1:
      price_data = web.DataReader(stocks, data_source='yahoo', start = start_date, end= end_date )
      price_data = price_data['Adj Close']
...
def return_stationarity(stock, start_date, end_date):
  ...
  return check_for_stationarity(X)
#-------------------------------------------------------------------------------------------------------------------------
def graph_rvolatility(stock, wts, start_date, end_date=today, window_time=180,x=20, y=10):
  if len(stock)==1:
...
def graph_ralpha(stock,wts, benchmark, start_date, end_date=today, window_time=180, x=20, y=10):
...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------
def graph_rbeta(stock,wts, benchmark, start_date, end_date=today, window_time=180, x=20, y=10):
