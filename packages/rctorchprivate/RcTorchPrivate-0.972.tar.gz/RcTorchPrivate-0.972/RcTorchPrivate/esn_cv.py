...
def execute_HRC(arguments):
    ...
    multiple_ICs = train_args["multiple_ICs"]
    ...
    for i, cv_sample in enumerate(cv_samples_):
        ...
        #divis = rounds *2
        if ODE_order:
            if multiple_ICs and not backprop_f:
...
class EchoStateNetworkCV:
    ...
    def optimize(self, y, x=None, store_path=None, epochs = 25, learning_rate = 0.005, scoring_method = "mse", criterion = MSELoss(), 
                    reparam_f = None, ODE_criterion = None, init_conditions = None, scale = True, force = None, backprop_f = None, backprop = False,
                     ...
                     nonlinear_ode = False, reg_type = "nl_ham", multiple_ICs = None):
