...
class ContentModulemdsApi(object):
    ...
    def create(self, relative_path, name, stream, version, static_context, context, arch, artifacts, dependencies, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create(relative_path, name, stream, version, static_context, context, arch, artifacts, dependencies, async_req=True)
        >>> result = thread.get()
        ...
        :param bool static_context: Modulemd static-context flag. (required)
        ...
        return self.create_with_http_info(relative_path, name, stream, version, static_context, context, arch, artifacts, dependencies, **kwargs)  # noqa: E501

    def create_with_http_info(self, relative_path, name, stream, version, static_context, context, arch, artifacts, dependencies, **kwargs):  # noqa: E501
        """Create a modulemd  # noqa: E501

        Trigger an asynchronous task to create content,optionally create new repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(relative_path, name, stream, version, static_context, context, arch, artifacts, dependencies, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('static_context' not in local_var_params or  # noqa: E501
                                                        local_var_params['static_context'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `static_context` when calling `create`")  # noqa: E501
