...
def run(
    ...
    assert workspace_config.exists(), f"Workspace config file '{workspace_config}' does not exist"
    assert requirements_file.exists(), f"Requirements file '{requirements_file}' does not exist"
