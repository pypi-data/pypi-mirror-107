...
from kalabash.lib.tests import KaldelaTestCase, KaldelaAPITestCase
...
class ViewsTestCase(TestDataMixin, KaldelaTestCase):
    """Check views."""
...
class AccessRuleTestCase(KaldelaTestCase):
...
class UserCalendarViewSetTestCase(TestDataMixin, KaldelaAPITestCase):
...
class SharedCalendarViewSetTestCase(TestDataMixin, KaldelaAPITestCase):
...
class AccessRuleViewSetTestCase(TestDataMixin, KaldelaAPITestCase):
...
class EventViewSetTestCase(TestDataMixin, KaldelaAPITestCase):
    """Event viewset tests."""
...
class AttendeeViewSetTestCase(KaldelaAPITestCase):
...
class MailboxViewSetTestCase(KaldelaAPITestCase):
