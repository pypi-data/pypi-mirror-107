...
from . import _AnisotropicDiffusionLBRPython
...
def coherence_enhancing_diffusion_image_filter(*args: itkt.ImageLike,  exponent: float=..., alpha: float=..., enhancement=..., noise_scale: float=..., feature_scale: float=..., ratio_to_max_stable_time_step: float=..., max_time_steps_between_tensor_updates: int=..., diffusion_time: float=..., adimensionize: bool=...,**kwargs)-> itkt.ImageSourceReturn:
    """Functional interface for CoherenceEnhancingDiffusionImageFilter"""
    import itk

    kwarg_typehints = { 'exponent':exponent,'alpha':alpha,'enhancement':enhancement,'noise_scale':noise_scale,'feature_scale':feature_scale,'ratio_to_max_stable_time_step':ratio_to_max_stable_time_step,'max_time_steps_between_tensor_updates':max_time_steps_between_tensor_updates,'diffusion_time':diffusion_time,'adimensionize':adimensionize }
...
def coherence_enhancing_diffusion_image_filter_init_docstring():
    ...
    filter_class = itk.AnisotropicDiffusionLBR.CoherenceEnhancingDiffusionImageFilter
    coherence_enhancing_diffusion_image_filter.process_object = filter_class
